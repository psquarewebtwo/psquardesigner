    ...
    var a = 0,
        ...
        g = {
            ...
            generateCss: function(a, b, d, c) {
                var f = [];
                g.clearCss(a);
                for (var e = 0, B = b.length; e < B; e++) f.push("#" + a + " ." + g.LINE_CLASS_PREFIX + e + " {" + (c[e] ? " white-space: normal;" : "") + (b[e] ? " font-size: " + b[e] + "px;" : "") + (d[e] ? " word-spacing: " + d[e] + "px;" : "") + "}");
            ...
            jQueryMethod: function(b) {
                ...
                this.each(function() {
                    var f = c(this).addClass("bigtext"),
                        e = f.width(),
                        n = f.attr("id"),
                        p = b.childSelector ? f.find(b.childSelector) : f.children();
                    ...
                    f = g.calculateSizes(f,
                        p, e, b.maxfontsize, b.minfontsize);
            ...
            calculateSizes: function(a, b, d, f, e) {
                ...
                b.css("float", "left").each(function() {
                    var a = c(this),
                        ...
                        y, l;
                    if (a.hasClass(g.EXEMPT_CLASS)) z.push(null), m.push(null), V.push(!1);
                    else {
                        l = parseFloat(a.css("font-size"));
                        l = (a.width() / l).toFixed(6);
                        l = parseInt(d / l, 10) - 32;
                        var k =
                            0,
                            B = b.length;
                        a: for (; k < B; k++) {
                            ...
                            b: for (; 10 >= I; I++) {
                                ...
                                y = g.testLineDimensions(a, d, "font-size", l + I * b[k], b[k], "px", y);
                                if ("number" !== typeof y) {
                                    l = y.size;
                                    if ("exact" === y.match) break a;
                                    break b
                                }
                            }
                        }
                        m.push(d / l);
                        l > f ? (z.push(f), V.push(!1)) : e && l < e ? (z.push(e), V.push(!0)) : (z.push(l), V.push(!1))
                    }
                }).each(function(a) {
                    var b = c(this),
                        f = 0,
                        e;
                    if (b.hasClass(g.EXEMPT_CLASS)) B.push(null);
                    else {
                        b.css("font-size", z[a] + "px");
                        for (a = 1; 3 > a; a += 1)
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    _gsScope._gsDefine("easing.CustomEase", ["easing.Ease"], function(b) {
        var c = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            ...
            d = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,
            f = /[cLlsS]/g,
            e = function(a, b, d, c, f, m, r, g, y, h, l) {
                var k, I = (a + d) / 2,
                    F = (b + c) / 2,
                    C = (d + f) / 2,
                    K = (c + m) / 2,
                ...
                return h || (h = [{
                    ...
                    x: r,
                    y: g
                }], l = 1), h.splice(l || h.length - 1, 0, {
                    x: D,
                    y: ea
                }), (d + f) * (d + f) > y * (Z * Z + na * na) && (k = h.length, e(a, b, I, F, J, W, D, ea, y, h, l), e(D, ea, C, K, G, Q, r, g, y, h, l + 1 + (h.length - k))), h
            },
            g = function(b) {
                var c, f, e, g, m, r, q, y, h, l, k = (b + "").replace(d, function(a) {
                        a = +a;
                    ...
                    G = 2;
                for (b = 0; K > b; b++)
                    if (y = e, isNaN(k[b]) ? (e = k[b].toUpperCase(), g = e !== k[b]) : b--, c = +k[b + 1], f = +k[b + 2], g && (c += F, f += C), b || (r = c, q = f), "M" === e) m && 8 > m.length && (--I.length, G =
                        0), F = r = c, C = q = f, m = [c, f], G = 2, I.push(m), b += 2, e = "L";
                    else if ("C" === e) m || (m = [0, 0]), m[G++] = c, m[G++] = f, g || (F = C = 0), m[G++] = F + 1 * k[b + 3], m[G++] = C + 1 * k[b + 4], m[G++] = F += 1 * k[b + 5], m[G++] = C += 1 * k[b + 6], b += 6;
                else if ("S" === e) "C" === y || "S" === y ? (h = F - m[G - 4], l = C - m[G - 3], m[G++] = F + h, m[G++] = C + l) : (m[G++] = F, m[G++] = C), m[G++] = c, m[G++] = f, g || (F = C = 0), m[G++] = F += 1 * k[b + 3], m[G++] = C += 1 * k[b + 4], b += 4;
                else {
                    if ("L" !== e && "Z" !== e) throw "CustomEase only accepts Cubic Bezier data.";
                    "Z" === e && (c = r, f = q, m.closed = !0);
                    ("L" === e || .5 < Math.abs(F - c) || .5 < Math.abs(C -
                        f)) && (m[G++] = F + (c - F) / 3, m[G++] = C + (f - C) / 3, m[G++] = F + 2 * (c - F) / 3, m[G++] = C + 2 * (f - C) / 3, m[G++] = c, m[G++] = f, "L" === e && (b += 2));
                    F = c;
                    C = f
                }
                return I[0]
            ...
            h = l.prototype = new b;
        return h.constructor = l, h.setData = function(a, b) {
            a = a || "0,0,1,1";
            var d, h, V, m, r, q, y;
            q = a.match(c);
            r = 1;
            var l = [];
            if (b = b || {}, y = b.precision || 1, this.data =
                a, this.lookup = [], this.points = l, this.fast = 1 >= y, (f.test(a) || -1 !== a.indexOf("M") && -1 === a.indexOf("C")) && (q = g(a)), d = q.length, 4 === d) q.unshift(0, 0), q.push(1, 1), d = 8;
            else if ((d - 2) % 6) throw "CustomEase only accepts Cubic Bezier data.";
            if (0 !== +q[0] || 1 !== +q[d - 2]) {
                m = q;
                var k = b.height,
                    L = b.originY;
                L || 0 === L || (L = Math.max(+m[m.length - 1], +m[1]));
                V = -1 * +m[0];
                var L = -L,
                    I = m.length,
                    F = 1 / (+m[I - 2] + V);
                if (!(k = -k))
                    if (Math.abs(+m[I - 1] - +m[1]) < .01 * (+m[I - 2] - +m[0])) {
                        for (var C = m.length, K = 999999999999, k = 1; C > k; k += 6) + m[k] < K && (K = +m[k]);
                        k =
                            K + L
                    } else k = +m[I - 1] + L;
                C = (C = k) ? 1 / C : -F;
                for (k = 0; I > k; k += 2) m[k] = (+m[k] + V) * F, m[k + 1] = (+m[k + 1] + L) * C
            }
            this.rawBezier = q;
            for (m = 2; d > m; m += 6) h = {
                x: +q[m - 2],
                ...
                x: +q[m + 4],
                y: +q[m + 5]
            }, l.push(h, V), e(h.x, h.y, +q[m], +q[m + 1], +q[m + 2], +q[m + 3], V.x, V.y, 1 / (2E5 * y), l, l.length - 1);
            d = l.length;
            for (m = 0; d > m; m++) y = l[m], q = l[m - 1] || y, y.x > q.x || q.y !== y.y && q.x === y.x || y === q ? (q.cx = y.x - q.x, q.cy = y.y - q.y, q.n = y, q.nx = y.x, this.fast && 1 < m && 2 < Math.abs(q.cy / q.cx - l[m - 2].cy / l[m - 2].cx) && (this.fast = !1), q.cx < r && (q.cx ? r = q.cx : (q.cx = .001, m === d - 1 && (q.x -=
                .001, r = Math.min(r, .001), this.fast = !1)))) : (l.splice(m--, 1), d--);
            if (d = 1 / r + 1 | 0, this.l = d, r = 1 / d, q = 0, y = l[0], this.fast) {
                for (m = 0; d > m; m++) V = m * r, y.nx < V && (y = l[++q]), h = y.y + (V - y.x) / y.cx * y.cy, this.lookup[m] = {
                    x: V,
                    cx: r,
                    y: h,
                    cy: 0,
                    nx: 9
                }, m && (this.lookup[m - 1].cy = h - this.lookup[m - 1].y);
                this.lookup[d - 1].cy = l[l.length - 1].y - h
            } else {
                for (m = 0; d > m; m++) y.nx < m * r && (y = l[++q]), this.lookup[m] = y;
                q < l.length - 1 && (this.lookup[m - 1] = l[l.length - 2])
            }
            return this._calcEnd = 1 !== l[l.length - 1].y || 0 !== l[0].y, this
        }, h.getRatio = k, h.getSVGData = function(a) {
            return l.getSVGData(this,
                a)
        }, l.create = function(a, b, d) {
            return new l(a, b, d)
        }, l.version = "0.2.2", l.bezierToPoints = e, l.get = function(a) {
            return b.map[a]
        }, l.getSVGData = function(a, d) {
            d = d || {};
            var c, f, e, m, r, g, y, l, h, k, I = d.width || 100,
                F = d.height || 100,
                C = d.x || 0,
                K = (d.y || 0) + F,
                G = d.path;
            if (d.invert && (F = -F, K = 0), a = a.getRatio ? a : b.map[a] || console.log("No ease found: ", a), a.rawBezier) {
                c = [];
                y = a.rawBezier.length;
                for (e = 0; y > e; e += 2) c.push((1E3 * (C + a.rawBezier[e] * I) | 0) / 1E3 + "," + (1E3 * (K + a.rawBezier[e + 1] * -F) | 0) / 1E3);
                c[0] = "M" + c[0];
                c[1] = "C" + c[1]
            } else
                for (c = ["M" + C + "," + K], y = Math.max(5, 200 * (d.precision || 1)), m = 1 / y, y += 2, l = 5 / y, h = (1E3 * (C + m * I) | 0) / 1E3, k = (1E3 * (K + a.getRatio(m) * -F) | 0) / 1E3, f = (k - K) / (h - C), e = 2; y > e; e++) r = (1E3 * (C + e * m * I) | 0) / 1E3, g = (1E3 * (K + a.getRatio(e * m) * -F) | 0) / 1E3, (Math.abs((g - k) / (r - h) - f) > l || e === y - 1) && (c.push(h + "," + k), f = (g - k) / (r - h)), h = r, k = g;
            return G && ("string" == typeof G ? document.querySelector(G) : G).setAttribute("d", c.join(" ")), c.join(" ")
        }, l
    }, !0)
});
...
! function(b) {
    ...
    c = d.special.debouncedresize = {
        ...
        handler: function(b, e) {
            ...
            a && clearTimeout(a);
            e ? l() : a = setTimeout(l, c.threshold)
        },
        threshold: 150
    }
}(jQuery);
...
(function() {
    ! function(b, c) {
        ...
        var b, c, a, d, f, e, g, k, l, h, n, p, z;
        return k = {}, a = document, h = !1, n = "active", e = 6E4, f = !1, c = function() {
                var a, b, d, c;
                return d = {}, a = function(a, b, c) {
                    ...
                    function(a, b, c) {
                        ...
                        if (a.__ceGUID && d[a.__ceGUID] && d[a.__ceGUID][b]) {
                            ...
                            r = [];
                            b = 0;
                            for (f = e.length; b < f; b++) a = e[b], r.push(a(c || {}));
                            return r
                        }
                    }, c = function(a, b, c) {
                        var f, e, r, g, h;
                        if (c) {
                            if (a.__ceGUID && d[a.__ceGUID] && d[a.__ceGUID][b])
                                for (h = d[a.__ceGUID][b], e = r = 0, g = h.length; r < g; e = ++r)
                ...
                return 4 < f ? f : void 0
            }(), d = !1, z = void 0, "undefined" != typeof a.hidden ? (d = "hidden", z = "visibilitychange") : "undefined" != typeof a.mozHidden ?
            (d = "mozHidden", z = "mozvisibilitychange") : "undefined" != typeof a.msHidden ? (d = "msHidden", z = "msvisibilitychange") : "undefined" != typeof a.webkitHidden && (d = "webkitHidden", z = "webkitvisibilitychange"), p = function() {
                var d, c;
                return d = [], c = function() {
                ...
                on: function(a, b) {
                    return l(), c.add(this, a, b), this
                },
                off: function(a, b) {
                    return l(), c.remove(this, a, b), this
                },
                onEvery: function(a, b) {
                    var d, c;
                    return l(), d = !1, b && (c = setInterval(function() {
...
! function(b) {
    var c = /iPhone/i,
        ...
        r = function(b) {
            ...
            var r = b.split("[FBAN");
            if ("undefined" != typeof r[1] && (b = r[0]), r = b.split("Twitter"), "undefined" != typeof r[1] && (b = r[0]), this.apple = {
                    phone: c.test(b),
                    ipod: a.test(b),
                    ...
                    phone: l.test(b),
                    tablet: h.test(b),
                    device: l.test(b) || h.test(b)
                }, this.other = {
                    blackberry: n.test(b),
                    blackberry10: p.test(b),
                    opera: z.test(b),
                    firefox: V.test(b),
                    chrome: B.test(b),
                    device: n.test(b) || p.test(b) || z.test(b) || V.test(b) || B.test(b)
    ...
    "undefined" != typeof module && module.exports && "undefined" == typeof window ? module.exports = r : "undefined" != typeof module && module.exports && "undefined" != typeof window ? module.exports = q() : "function" == typeof define && define.amd ? define("isMobile", [], b.isMobile = q()) : b.isMobile = q()
}(this);
...
var ytp = ytp || {},
    getYTPVideoID = function(b) {
        var c, a;
        return 0 < b.indexOf("youtu.be") ? (c = b.substr(b.lastIndexOf("/") + 1, b.length), a = 0 < c.indexOf("?list=") ? c.substr(c.lastIndexOf("="), c.length) : null, c = a ? c.substr(0, c.lastIndexOf("?")) : c) : -1 < b.indexOf("http") ? (c = b.match(/[\\?&]v=([^&#]*)/)[1], a = 0 < b.indexOf("list=") ? b.match(/[\\?&]list=([^&#]*)/)[1] : null) : (c = 15 < b.length ? null : b, a = c ? null : b), {
            videoID: c,
            playlistID: a
        }
    };
! function(b, c) {
    b.mbYTPlayer = {
        ...
        buildPlayer: function(a) {
            ...
            return this.each(function() {
                ...
                if (b.mbCookie.get("YTPlayer_start_from" + f.videoID) && (k = parseFloat(b.mbCookie.get("YTPlayer_start_from" + f.videoID))), f.opt.remember_last_time && k && (f.start_from_last = k, b.mbCookie.remove("YTPlayer_start_from" + f.videoID)), f.isPlayer = g.is(f.opt.containment), f.isBackground = f.opt.containment.is("body"), !f.isBackground || !c.backgroundIsInited) {
                    ...
                    f.isPlayer && (f.inlinePlayButton = b("<div/>").addClass("inlinePlayButton").html(b.mbYTPlayer.controls.play), g.append(f.inlinePlayButton), f.inlinePlayButton.on("click", function(a) {
                            g.YTPPlay();
                            a.stopPropagation()
                        }), f.opt.autoPlay &&
                        f.inlinePlayButton.hide(), f.overlay.on("click", function() {
                            g.YTPTogglePlay()
                        }).css({
                            cursor: "pointer"
                        }));
                    ...
                    if (k.css({
                            ...
                            position: "relative"
                        }), g.show()), f.opt.containment.prepend(f.wrapper), f.isBackground || f.overlay.on("mouseenter",
                            function() {
                    ...
                    b.mbBrowser.mobile && f.opt.autoPlay && f.opt.useOnMobile &&
                        b("body").one("touchstart", function() {
                            f.player.playVideo()
                        });
                    ...
                    g.one("YTAPIReady_" + f.id, function() {
                        var a = this,
                            d = b(a);
                        a.isBackground && c.backgroundIsInited || a.isInit || (a.isBackground && (c.backgroundIsInited = !0), a.opt.autoPlay = "undefined" == typeof a.opt.autoPlay ? !!a.isBackground : a.opt.autoPlay, a.opt.vol = a.opt.vol ? a.opt.vol : 100, b.mbYTPlayer.getDataFromAPI(a),
                            b(a).on("YTPChanged", function(c) {
        ...
        getDataFromAPI: function(a) {
            if (a.videoData = b.mbStorage.get("YTPlayer_data_" + a.videoID), b(a).off("YTPData.YTPlayer").on("YTPData.YTPlayer", function() {
                    a.hasData && a.isPlayer && !a.opt.autoPlay && a.opt.containment.css({
                        background: "rgba(0,0,0,0.5) url(" + ("false" != a.opt.coverImage ? a.opt.coverImage : a.videoData.thumb_max || a.videoData.thumb_high || a.videoData.thumb_medium) + ") center center",
                        backgroundSize: "cover"
                    })
                ...
                if (setTimeout(function() {
                    ...
                    var d = "false" != a.opt.coverImage ? a.opt.coverImage : b.mbYTPlayer.locationProtocol + "//i.ytimg.com/vi/" + a.videoID + "/maxresdefault.jpg";
            ...
            a.isPlayer && !a.opt.autoPlay && (a.loading = b("<div/>").addClass("loading").html("Loading").hide(), b(a).append(a.loading), a.loading.fadeIn())
        },
        ...
        playlist: function(a, d, c) {
            function e(l,
                h) {
                h = h || "";
                b.getJSON("https://www.googleapis.com/youtube/v3/playlistItems", {
                    part: "snippet,contentDetails",
                    playlistId: l,
                    maxResults: 50,
                    pageToken: h,
                    key: b.mbYTPlayer.apiKey
                }).done(function(b) {
                    for (var l = b.items.length, z = 0; l > z; z++) k.videos.push({
                        videoURL: b.items[z].contentDetails.videoId
                    });
                    b.nextPageToken ? (h = b.nextPageToken, e(plID, h, a)) : g.YTPlaylist(k.videos, d, c)
                })
            }
            var g = this,
                k = g.get(0);
            return "String" == typeof a && "" != b.mbYTPlayer.apiKey ? (e(a), this) : (k.isList = !0, d && (a = b.shuffle(a)), k.videoID || (k.videos = a,
                k.videoCounter = 1, k.videoLength = a.length, b(k).data("property", a[0]), b(k).YTPlayer()), "function" == typeof c && b(k).one("YTPChanged", function() {
                c(k)
            }), b(k).on("YTPEnd", function() {
                b(k).YTPPlayNext()
            }), this)
        },
        playNext: function() {
        ...
        playIndex: function(a) {
            var d = this.get(0);
            d.checkForStartAt && (clearInterval(d.checkForStartAt), clearInterval(d.getState));
            d.videoCounter = a;
        ...
        getPlayer: function() {
            return b(this).get(0).player
        },
        playerDestroy: function() {
            var a = this.get(0);
            return c.YTAPIReady = !0, c.backgroundIsInited = !1, a.isInit = !1, a.videoID = null, a.isReady = !1, a.wrapper.remove(), b("#controlBar_" + a.id).remove(), clearInterval(a.checkForStartAt), clearInterval(a.getState), this
        },
        fullscreen: function(a) {
            ...
            function c(a, b) {
                for (var d, f, e = ["webkit", "moz", "ms", "o", ""], r = 0; r < e.length && !a[d];) {
                    if (d = b, "" == e[r] && (d = d.substr(0, 1).toLowerCase() + d.substr(1)), d = e[r] + d, f = typeof a[d], "undefined" != f) return "function" ==
                        f ? a[d]() : a[d];
                    r++
                }
            }
            ...
            var k = b("#controlBar_" + g.id),
                l = k.find(".mb_OnlyYT"),
                h = g.isPlayer ? g.opt.containment : g.wrapper;
            if (a) {
                ...
                b(document).off(n).on(n, function() {
                    c(document, "IsFullScreen") || c(document, "FullScreen") ? (b(g).YTPSetVideoQuality("default"), b(g).trigger("YTPFullScreenStart")) : (g.isAlone = !1, l.html(b.mbYTPlayer.controls.onlyYT), b(g).YTPSetVideoQuality(g.opt.quality), h.removeClass("YTPFullscreen"), h.CSSAnimate({
                        opacity: g.opt.opacity
                    }, g.opt.fadeOnStartTime), h.css({
                        zIndex: 0
            ...
            g.isAlone ? (b(document).off("mousemove.YTPlayer"), clearTimeout(g.hideCursor), g.overlay.css({
                cursor: "auto"
            }), a ? (c(document, "FullScreen") || c(document, "IsFullScreen")) && c(document, "CancelFullScreen") : (h.CSSAnimate({
                    opacity: g.opt.opacity
                },
                g.opt.fadeOnStartTime), h.css({
                zIndex: 0
            })), l.html(b.mbYTPlayer.controls.onlyYT), g.isAlone = !1) : (b(document).on("mousemove.YTPlayer", function(a) {
                    g.overlay.css({
                        cursor: "auto"
                    });
                    ...
                    opacity: 0
                }), h.addClass("YTPFullscreen"), e(h.get(0)), setTimeout(function() {
                    h.CSSAnimate({
                        opacity: 1
                ...
                }, g.opt.fadeOnStartTime)) :
                h.css({
                    zIndex: 1E4
                }).CSSAnimate({
                    opacity: 1
                }, 2 * g.opt.fadeOnStartTime), l.html(b.mbYTPlayer.controls.showSite), g.isAlone = !0);
            return this
        },
        ...
        play: function() {
            ...
            return b("#controlBar_" + a.id).find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.pause), a.state = 1, a.orig_background = b(a).css("background-image"), this
        },
        ...
        stop: function() {
            var a = this.get(0);
            return b("#controlBar_" + a.id).find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play), a.player.stopVideo(), this
        },
        pause: function() {
            var a = this.get(0);
            return a.player.pauseVideo(), a.state =
                2, this
        },
        seekTo: function(a) {
        ...
        toggleVolume: function() {
            var a = this.get(0);
            return a ? (a.isMute ? (b.mbBrowser.mobile || this.YTPSetVolume(a.opt.vol), this.YTPUnmute()) : this.YTPMute(), this) : this
        },
        mute: function() {
            var a = this.get(0);
            ...
            return d.time = a.currentTime, a.preventTrigger || b(a).trigger(d), this
        },
        unmute: function() {
            var a = this.get(0);
            if (!a.isMute) return this;
        ...
        toggleFilter: function(a, d) {
            var c = this.get(0);
            return c.filters[a].value ? c.filters[a].value = 0 : c.filters[a].value = d, c.filtersEnabled && b(c).YTPEnableFilters(), this
        },
        toggleFilters: function(a) {
            var d = this.get(0);
            return d.filtersEnabled ? (b(d).trigger("YTPDisableFilters"), b(d).YTPDisableFilters()) : (b(d).YTPEnableFilters(), b(d).trigger("YTPEnableFilters")),
                "function" == typeof a && a(d.filtersEnabled), this
        },
        ...
        removeFilter: function(a, d) {
            ...
            if ("function" == typeof a &&
                (d = a, a = null), a) this.YTPApplyFilter(a, 0), "function" == typeof d && d(a);
            else {
                for (var e in c.filters) this.YTPApplyFilter(e, 0);
                "function" == typeof d && d(e);
                c.filters = b.extend(!0, {}, b.mbYTPlayer.defaultFilters)
            }
        ...
        applyMask: function(a) {
            ...
            if (d.off("YTPTime.mask"), a.opt.mask)
                if ("string" == typeof a.opt.mask) d.YTPAddMask(a.opt.mask), a.actualMask = a.opt.mask;
        ...
        toggleMask: function() {
            var a = this.get(0),
                d = b(a);
            return a.hasMask ? d.YTPRemoveMask() : d.YTPAddMask(), this
        },
        ...
        buildControls: function(a) {
            ...
            if (a.opt.showYTLogo = a.opt.showYTLogo || a.opt.printUrl, !b("#controlBar_" + a.id).length) {
                ...
                var d = b("<div/>").addClass("buttonBar"),
                    c = b("<span>" + b.mbYTPlayer.controls.play + "</span>").addClass("mb_YTPPlayPause ytpicon").on("click",
                        function(d) {
                            d.stopPropagation();
                            b(a).YTPTogglePlay()
                        }),
                    e = b("<span>" + b.mbYTPlayer.controls.mute + "</span>").addClass("mb_YTPMuteUnmute ytpicon").on("click", function(d) {
                        d.stopPropagation();
                        b(a).YTPToggleVolume()
                    }),
                ...
                var k = b("<span/>").addClass("mb_YTPTime"),
                    l = a.opt.videoURL ? a.opt.videoURL : "";
                0 > l.indexOf("http") && (l = b.mbYTPlayer.locationProtocol + "//www.youtube.com/watch?v=" + a.opt.videoURL);
                var h = b("<span/>").html(b.mbYTPlayer.controls.ytLogo).addClass("mb_YTPUrl ytpicon").attr("title",
                    ...
                    p = b("<div/>").addClass("mb_YTPProgress").css("position", "absolute").on("click", function(b) {
                        b.stopPropagation();
                        B.css({
                            width: b.clientX - B.offset().left
                        });
                        a.timeW = b.clientX - B.offset().left;
                        a.controlBar.find(".mb_YTPLoaded").css({
                            width: 0
                        });
                        b = Math.floor(a.player.getDuration());
                        a["goto"] = B.outerWidth() * b / p.outerWidth();
                        a.player.seekTo(parseFloat(a["goto"]), !0);
                        a.controlBar.find(".mb_YTPLoaded").css({
                            width: 0
                        })
                    }),
                    z = b("<div/>").addClass("mb_YTPLoaded").css("position", "absolute"),
                    B = b("<div/>").addClass("mb_YTPseekbar").css("position", "absolute");
                p.append(z).append(B);
                d.append(c).append(e).append(g).append(k);
                a.opt.showYTLogo && d.append(h);
                (a.isBackground || eval(a.opt.realfullscreen) && !a.isBackground) && d.append(n);
                a.controlBar.append(d).append(p);
                    ...
                    if ((a.controlBar.length && 400 >= a.controlBar.outerWidth() && !a.isCompact ? (a.controlBar.addClass("compact"),
                        ...
                        if (a.isEnded = !0, setTimeout(function() {
                            ...
                            function() {
                                ...
                                a.isBackground ? a.orig_background && b(a).css("background-image", a.orig_background) : a.opt.coverImage && a.isPlayer && (a.opt.coverImage = a.opt.coverImage || a.orig_background, a.opt.containment.css({
                                    background: "url(" + a.opt.coverImage + ") center center",
                                    backgroundSize: "cover"
                                }))
                            });
                        a.player.loopTime =
                            a.player.loopTime ? ++a.player.loopTime : 1;
        ...
        checkForStart: function(a) {
            ...
            return a.preventTrigger = !0, a.player.playVideo(), d.YTPMute(), a.player.seekTo(e, !0), a.isStarting = !0, a.checkForStartAt = setInterval(function() {
                ...
                0 < a.player.getDuration() && a.player.getCurrentTime() >= e && c ? (a.start_from_last = null, clearInterval(a.checkForStartAt), "function" == typeof a.opt.onReady && a.opt.onReady(a), a.isReady = !0, d.YTPRemoveFilter(), a.opt.addFilters ? d.YTPApplyFilters(a.opt.addFilters) : d.YTPApplyFilters({}), d.YTPEnableFilters(), c = b.Event("YTPReady"), (c.time = a.currentTime, b(a).trigger(c), a.state = 2, b(a).YTPPause(), a.opt.mute || b(a).YTPUnmute(), "undefined" != typeof _gaq && eval(a.opt.gaTrack) ? _gaq.push(["_trackEvent", "YTPlayer", "Play", a.hasData ?
                        a.videoData.title : a.videoID.toString()
                    ]) : "undefined" != typeof ga && eval(a.opt.gaTrack) && ga("send", "event", "YTPlayer", "play", a.hasData ? a.videoData.title : a.videoID.toString()), a.opt.autoPlay) ? (c = b.Event("YTPStart"), c.time = a.currentTime, b(a).trigger(c), a.isStarting = !1, "mac" == b.mbBrowser.os.name && b.mbBrowser.safari ? setTimeout(function() {
                        d.YTPPlay()
                    }, 10) : d.YTPPlay()) : (a.player.pauseVideo(), setTimeout(function() {
                        ...
                        a.isPlayer || (a.opt.coverImage ? (a.wrapper.css({
                            ...
                            setTimeout(function() {
                                a.wrapper.css({
                                    background: "rgba(0,0,0,0.5) url(" + a.opt.coverImage + ") center center",
                                    backgroundSize: "cover",
                                    backgroundRepeat: "no-repeat"
                                })
                        ...
                        a.isStarting = !1
                    }, 150), a.controlBar.length && a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play)), a.isPlayer && !a.opt.autoPlay && a.loading && a.loading.length &&
                    (a.loading.html("Ready"), setTimeout(function() {
                        a.loading.fadeOut()
                    }, 100)), a.controlBar && a.controlBar.length && a.controlBar.slideDown(1E3)) : "mac" == b.mbBrowser.os.name && b.mbBrowser.safari && (a.player.playVideo(), 0 <= e && a.player.seekTo(e, !0))
            }, 500), d
        },
        getTime: function() {
            var a = this.get(0);
    ...
    b.fn.optimizeDisplay = function(a) {
        ...
        if (d.opt.optimizeDisplay) {
            ...
            k = 0;
            var p = e < n;
            p && (e = n, c = Math.ceil(e * d.opt.ratio), g = 0, k = Math.ceil(-((c - h) / 2)));
            for (var z in a)
                if (a.hasOwnProperty(z)) switch (a[z].replace(/ /g, "")) {
                    case "top":
                        g = p ? -((e - n) / 2) : 0;
                        break;
                    case "bottom":
    ...
    b.fn.YTPChangeVideo = b.fn.YTPChangeMovie = b.mbYTPlayer.changeVideo;
...
jQuery.CSS = {
    ...
    animate: function(b, c, a, d, f) {
        return this.each(function() {
            ...
            if (g.CSSAIsRunning && g.eventType == l.type && !jQuery.browser.msie && 9 >= jQuery.browser.version) g.CSSqueue = function() {
                k.CSSAnimate(b, c, a, d, f)
            };
            else if (g.CSSqueue = null, g.eventType = l.type, 0 !== k.length &&
                b) {
                if (b = jQuery.normalizeCss(b), g.CSSAIsRunning = !0, "function" == typeof c && (f = c, c = jQuery.fx.speeds._default), "function" == typeof a && (d = a, a = 0), "string" == typeof a && (f = a, a = 0), "function" == typeof d && (f = d, d = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof c)
                    for (var h in jQuery.fx.speeds) {
                        if (c == h) {
                            c = jQuery.fx.speeds[h];
                            break
                        }
                ...
                if (c || (c = jQuery.fx.speeds._default), "string" == typeof f && (d = f, f = null), jQuery.support.CSStransition) {
                    ...
                    var n = jQuery.CSS.getProp(b),
                        p = {};
                    jQuery.extend(p, b);
                    p[jQuery.CSS.sfx + "transition-property"] = n;
                    p[jQuery.CSS.sfx + "transition-duration"] = c + "ms";
                    p[jQuery.CSS.sfx + "transition-delay"] = a + "ms";
                    ...
                    for (n in b) "transform" === n && delete b[n], "filter" === n && delete b[n], "transform-origin" === n && delete b[n], "auto" === b[n] && delete b[n], "x" === n && (l = b[n], h = "left", b[h] = l, delete b[n]), "y" === n && (l = b[n], h = "top", b[h] = l, delete b[n]), "-ms-transform" !== n && "-ms-filter" !== n || delete b[n];
            ...
            d = function(b) {
                var d = b.dataset ? b.dataset.objectFit : b.getAttribute("data-object-fit"),
                    ...
                    h = window.getComputedStyle(f,
                        null),
                    n = h.getPropertyValue("position"),
                    p = h.getPropertyValue("overflow"),
                    h = h.getPropertyValue("display");
                n && "static" !== n || (f.style.position = "relative");
                "hidden" !== p && (f.style.overflow = "hidden");
                h && "inline" !== h || (f.style.display = "block");
                ...
                var n = window.getComputedStyle(b, null),
                    ...
                    z;
                for (z in p) n.getPropertyValue(z) !== p[z] && (b.style[z] = p[z]);
    ...
    c._dispatchEvent = function(a, b) {
        ...
        if (a && g && (e = g[a.type]) && (c = e.length)) {
            ...
            for (g = 0; c > g && !a.immediatePropagationStopped; g++) {
                ...
                a.removed && (this.off(a.type, l, 1 == b), a.removed = !1)
            }
        }
...
(function() {
    function b(d, c) {
        function e(a) {
            ...
            if ("bug-string-char-index" == a) b = "a" != "a" [0];
                ...
                if ("json-stringify" == a) {
                    b = c.stringify;
                    var f = "function" == typeof b && K;
                    if (f) {
                        (d = function() {
                            return 1
                        }).toJSON = d;
                        try {
                            f = "0" === b(0) && "0" === b(new g) && '""' == b(new h) && b(C) === F && b(F) === F && b() === F && "1" === b(d) && "[1]" == b([d]) && "[null]" == b([F]) && "null" == b(null) && "[null,null,null]" == b([F, C, null]) && '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}' ==
                                b({
                                    a: [d, !0, !1, null, "\x00\b\n\f\r\t"]
        ...
        var g = d.Number || f.Number,
            ...
            y = d.TypeError || f.TypeError,
            k = d.Math || f.Math,
            l = d.JSON || f.JSON;
        "object" == typeof l && l && (c.stringify = l.stringify, c.parse = l.parse);
        var L, I, F, m = m.prototype,
            C = m.toString,
            K = new r(-0xc782b5b800cec);
        try {
        ...
        if (!e("json")) {
            var Q = e("bug-string-char-index");
            if (!K) var J = k.floor,
                W = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                D = function(a, b) {
                    return W[b] + 365 * (a - 1970) + J((a - 1969 + (b = +(1 < b))) / 4) - J((a - 1901 + b) / 100) + J((a - 1601 + b) / 400)
                };
            if ((L = m.hasOwnProperty) || (L = function(a) {
                    var b, d = {};
                    return (d.__proto__ = null, d.__proto__ = {
                        toString: 1
                    }, d).toString != C ? L = function(a) {
                        var b = this.__proto__;
                        a = a in (this.__proto__ = null, this);
                        return this.__proto__ = b, a
                    } : (b = d.constructor, L = function(a) {
                        var d = (this.constructor || b).prototype;
                        return a in this && !(a in d && this[a] === d[a])
                    }), d = null, L.call(this, a)
                }), I = function(b, d) {
                    var c, f, e, r = 0;
                    (c = function() {
                        this.valueOf = 0
                    ...
                    f = new c;
                    for (e in f) L.call(f, e) && r++;
                    return c = f = null, r ? I = 2 == r ? function(a, b) {
                        var d, c = {},
                            f = "[object Function]" == C.call(a);
                        for (d in a) f && "prototype" == d || L.call(c, d) || !(c[d] = 1) || !L.call(a, d) || b(d)
                    } : function(a, b) {
                        var d, c, f = "[object Function]" == C.call(a);
                        for (d in a) f &&
                            "prototype" == d || !L.call(a, d) || (c = "constructor" === d) || b(d);
                        (c || L.call(a, d = "constructor")) && b(d)
                    } : (f = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), I = function(b, d) {
                        var c, e;
                        e = "[object Function]" == C.call(b);
                        var r = !e && "function" != typeof b.constructor && a[typeof b.hasOwnProperty] && b.hasOwnProperty || L;
                        for (c in b) e && "prototype" == c || !r.call(b, c) || d(c);
                        for (e = f.length; c = f[--e]; r.call(b, c) && d(c));
                    }), I(b, d)
                }, !e("json-stringify")) {
                var ea = {
                        92: "\\\\",
                    ...
                    na = function(a) {
                        for (var b = '"', d = 0, c = a.length, f = !Q || 10 < c, e = f && (Q ? a.split("") : a); c > d; d++) {
                            var r = a.charCodeAt(d);
                            switch (r) {
                                case 8:
                                case 9:
                                case 10:
                    ...
                    ha = function(a, b, d, c, f, e, r) {
                        var m, g, t, q, h, k, V, l, X, z;
                        try {
                            m = b[a]
                        } catch (p) {}
                        if ("object" == typeof m && m)
                            if (g = C.call(m), "[object Date]" !=
                                g || L.call(m, "toJSON")) "function" == typeof m.toJSON && ("[object Number]" != g && "[object String]" != g && "[object Array]" != g || L.call(m, "toJSON")) && (m = m.toJSON(a));
                            else if (m > -1 / 0 && 1 / 0 > m) {
                            if (D) {
                                h = J(m / 864E5);
                                for (t = J(h / 365.2425) + 1970 - 1; D(t + 1, 0) <= h; t++);
                                for (q = J((h - D(t, 0)) / 30.42); D(t, q + 1) <= h; q++);
                                h = 1 + h - D(t, q);
                                ...
                                X = J(k / 1E3) % 60;
                                k %= 1E3
                            } else t = m.getUTCFullYear(), q = m.getUTCMonth(), h = m.getUTCDate(), V = m.getUTCHours(), l = m.getUTCMinutes(), X = m.getUTCSeconds(), k = m.getUTCMilliseconds();
                            m = (0 >= t || 1E4 <= t ? (0 > t ? "-" : "+") + Z(6, 0 > t ? -t : t) : Z(4, t)) + "-" + Z(2, q + 1) + "-" + Z(2, h) + "T" + Z(2, V) + ":" + Z(2, l) + ":" + Z(2, X) + "." + Z(3, k) + "Z"
                        } else m = null;
                        if (d && (m = d.call(b, a, m)), null === m) return "null";
                        if (g = C.call(m), "[object Boolean]" == g) return "" + m;
                        if ("[object Number]" == g) return m > -1 / 0 && 1 / 0 > m ? "" + m : "null";
                        if ("[object String]" == g) return na("" + m);
                        if ("object" == typeof m) {
                            for (a = r.length; a--;)
                                if (r[a] === m) throw y();
                            if (r.push(m), z = [], b = e, e += f, "[object Array]" == g) {
                                t = 0;
                                for (a = m.length; a > t; t++) g = ha(t, m, d, c, f, e, r), z.push(g === F ? "null" :
                                    g);
                                g = z.length ? f ? "[\n" + e + z.join(",\n" + e) + "\n" + b + "]" : "[" + z.join(",") + "]" : "[]"
                            } else I(c || m, function(a) {
                                var b = ha(a, m, d, c, f, e, r);
                                b !== F && z.push(na(a) + ":" + (f ? " " : "") + b)
                            }), g = z.length ? f ? "{\n" + e + z.join(",\n" + e) + "\n" + b + "}" : "{" + z.join(",") + "}" : "{}";
                            return r.pop(), g
                        }
                ...
                c.stringify = function(b, d, c) {
                    var f, e, r, m;
                    if (a[typeof d] && d)
                        if ("[object Function]" == (m = C.call(d))) e = d;
                        else if ("[object Array]" == m) {
                        r = {};
                        for (var g, q = 0, t = d.length; t > q; g = d[q++], m = C.call(g), ("[object String]" == m || "[object Number]" == m) && (r[g] = 1));
                    }
                    if (c)
                        if ("[object Number]" ==
                            (m = C.call(c))) {
                    ...
                    return ha("", (g = {}, g[""] = b, g), e, r, f, "", [])
                }
            }
            if (!e("json-parse")) {
                var H, x, la = h.fromCharCode,
                    ma = {
                        92: "\\",
                        34: '"',
                        47: "/",
                    ...
                    ca = function() {
                        for (var a, b, d, c, f, e = x, r = e.length; r > H;) switch (f = e.charCodeAt(H)) {
                            case 9:
                            case 10:
                            case 13:
                            case 32:
                            ...
                            case 44:
                                return a =
                                    Q ? e.charAt(H) : e[H], H++, a;
                            case 34:
                                a = "@";
                                for (H++; r > H;)
                                    if (f = e.charCodeAt(H), 32 > f) Y();
                                    else if (92 == f) switch (f = e.charCodeAt(++H)) {
                                    case 92:
                                    case 34:
                                    case 47:
                                    case 98:
                                    ...
                                    case 117:
                                        b = ++H;
                                        for (d = H + 4; d > H; H++) f = e.charCodeAt(H), 48 <= f && 57 >= f || 97 <= f && 102 >= f || 65 <= f && 70 >= f || Y();
                                        a += la("0x" + e.slice(b, H));
                                        break;
                                    default:
                                        Y()
                                    ...
                                    if (34 == f) break;
                                    f = e.charCodeAt(H);
                                    for (b = H; 32 <= f && 92 != f && 34 != f;) f = e.charCodeAt(++H);
                                    a += e.slice(b, H)
                                }
                                if (34 == e.charCodeAt(H)) return H++, a;
                                Y();
                            default:
                                if (b =
                                    H, 45 == f && (c = !0, f = e.charCodeAt(++H)), 48 <= f && 57 >= f) {
                                    for (48 == f && (f = e.charCodeAt(H + 1), 48 <= f && 57 >= f) && Y(); r > H && (f = e.charCodeAt(H), 48 <= f && 57 >= f); H++);
                                    if (46 == e.charCodeAt(H)) {
                                        for (d = ++H; r > d && (f = e.charCodeAt(d), 48 <= f && 57 >= f); d++);
                                        d == H && Y();
                                        H = d
                                    }
                                    if (f = e.charCodeAt(H), 101 == f || 69 == f) {
                                        f = e.charCodeAt(++H);
                                        43 != f && 45 != f || H++;
                                        for (d = H; r > d && (f = e.charCodeAt(d), 48 <= f && 57 >= f); d++);
                                        d == H && Y();
                                ...
                                if (c && Y(), "true" == e.slice(H, H + 4)) return H += 4, !0;
                                if ("false" == e.slice(H, H + 5)) return H += 5, !1;
                                if ("null" == e.slice(H,
                                        H + 4)) return H += 4, null;
                                Y()
                        }
                    ...
                    ia = function(a) {
                        ...
                        if ("$" == a && Y(), "string" == typeof a) {
                            if ("@" == (Q ? a.charAt(0) : a[0])) return a.slice(1);
                            if ("[" == a) {
                                for (b = []; a = ca(), "]" != a; d || (d = !0)) d && ("," == a ? (a = ca(), "]" == a && Y()) : Y()), "," == a && Y(), b.push(ia(a));
                                return b
                            }
                            if ("{" == a) {
                                for (b = {}; a = ca(), "}" != a; d || (d = !0)) d && ("," == a ? (a = ca(), "}" == a && Y()) : Y()), "," != a && "string" == typeof a && "@" == (Q ? a.charAt(0) : a[0]) && ":" == ca() || Y(), b[a.slice(1)] = ia(ca());
                                return b
                            }
                            Y()
                        }
                ...
                c.parse = function(a, b) {
                    var d, c;
                    return H = 0, x = "" + a, d = ia(ca()), "$" != ca() && Y(), H = x = null, b && "[object Function]" == C.call(b) ? pa((c = {}, c[""] = d, c), "", b) : d
                }
            }
        }
    ...
    if (!e || e.global !== e && e.window !== e && e.self !== e || (f = e), d && !c) b(f, d);
        ...
        var g = f.JSON,
            ...
            h = b(f, f.JSON3 = {
                noConflict: function() {
                    return l || (l = !0, f.JSON = g, f.JSON3 = k, g = k = null), h
                }
            });
        f.JSON = {
            parse: h.parse,
    ...
    c._createXHR = function(a) {
        ...
        if (window.XMLHttpRequest) e = new XMLHttpRequest, b && void 0 === e.withCredentials && window.XDomainRequest && (e = new XDomainRequest);
            ...
            for (var g = 0, k = s.ACTIVEX_VERSIONS.length; k > g; g++) {
                var l = s.ACTIVEX_VERSIONS[g];
                try {
                    e = new ActiveXObject(l);
                    break
                } catch (h) {}
            }
            if (null ==
...
(function() {
    ...
    c.unregisterLoader = function(a) {
        ...
        1 != a && a < this._defaultLoaderLength - 1 && this._availableLoaders.splice(a, 1)
    };
    ...
    c.remove = function(a) {
        ...
        if (b) {
            for (; b.length;) {
                for (var g = b.pop(), k = this.getResult(g), l = this._loadQueue.length - 1; 0 <= l; l--)
                    if (h = this._loadQueue[l].getItem(), h.id == g || h.src == g) {
                        this._loadQueue.splice(l,
                            1)[0].cancel();
                        break
                    }
                for (l = this._loadQueueBackup.length - 1; 0 <= l; l--)
                    if (h = this._loadQueueBackup[l].getItem(), h.id == g || h.src == g) {
                        this._loadQueueBackup.splice(l, 1)[0].cancel();
                        break
                    }
                if (k) this._disposeItem(this.getItem(g));
                else
                    for (l = this._currentLoads.length - 1; 0 <= l; l--) {
                        var h = this._currentLoads[l].getItem();
                        if (h.id == g || h.src == g) {
                            this._currentLoads.splice(l, 1)[0].cancel();
                            c = !0;
                            break
                        }
                    }
    ...
    c.loadManifest = function(a, c, e) {
        ...
        a = 0;
        for (var l = g.length; l > a; a++) this._addItem(g[a], k, e);
    ...
    c._createLoadItem = function(a, b, c) {
        ...
        if (a.src instanceof Object) {
            ...
            var l = a.src;
            k.absolute || k.relative || (b ? (g = b, k = createjs.URLUtils.parseURI(b), l = b + l,
                null == c || k.absolute || k.relative || (g = c + g)) : null != c && (g = c));
            a.src = g + a.src
        }
        a.path = g;
        void 0 !== a.id && null !== a.id && "" !== a.id || (a.id = l);
...
(function() {
    ...
    c._watch = function() {
        for (var a = this._watched, c = b._referenceFonts, f = a.length, e = f - 1; 0 <= e; e--)
            for (var g = a[e], k =
                    g.refs, l = k.length - 1; 0 <= l; l--)
                if (this._getTextWidth(g.family + "," + c[l], g.weight, g.style) != k[l]) {
    ...
    c._defFromSrc =
        function(a) {
            ...
            var l = e.match(b.STYLE_REGEX);
            l && (c = c.replace(l[0], ""), l = "italic");
            c = c.replace(f, "");
...
(function() {
    ...
    b._parsePath = function(a) {
        ...
        if (null == c) return !1;
        for (var e = c[4], g = c[5], k = b.capabilities, l = 0; !k[g];)
            if (g = b.alternateExtensions[l++], l > b.alternateExtensions.length) return null;
        a = a.replace("." + c[5], "." + g);
        return {
            name: e,
            src: a,
    ...
    b.createInstance = function(a, f, e) {
        ...
        var k = b._parsePath(a.src),
            l = null;
        return null != k && null != k.src ? (c.create(k.src), null == f && (f = a.startTime), l = b.activePlugin.create(k.src, f, e || a.duration), g = g || b._defaultPlayPropsHash[k.src], g && l.applyPlayProps(g)) : l = new createjs.DefaultSoundInstance(a, f, e), l.uniqueId = b._lastID++, l
    };
    b.stop = function() {
    ...
    a._generateCapabilities = function() {
        if (null == a._capabilities) {
            ...
            for (var c = createjs.Sound.SUPPORTED_EXTENSIONS,
                ...
                var l = c[g],
                    h = e[l] || l;
                a._capabilities[l] = "no" != b.canPlayType("audio/" + l) && "" != b.canPlayType("audio/" + l) || "no" != b.canPlayType("audio/" + h) && "" != b.canPlayType("audio/" + h)
            }
...
! function(b) {
    var c = b.GreenSockGlobals || b,
        ...
        m = a.SplitText = c.SplitText = function(a, b) {
            ...
            if (l(a)) {
                ...
                for (d = 0; g > d; d++)
                    if (e = c[d], l(e))
                        for (f = 0; f < e.length; f++) r.push(e[f]);
                    else r.push(e);
                c = r
            } else c = [a];
            this.elements = c;
        ...
        L = function(a, b, c, e) {
            var m, g, q = y(a.childNodes),
                V = q.length,
                l = "absolute" === b.position || !0 === b.absolute;
            if (3 !== a.nodeType || 1 < V) {
                b.absolute = !1;
                for (m = 0; V > m; m++) g = q[m], (3 !== g.nodeType || /\S+/.test(g.nodeValue)) && (l && 3 !== g.nodeType && "inline" ===
                    k(g, "display", null, !0) && (g.style.display = "inline-block", g.style.position = "relative"), g._isSplit = !0, L(g, b, c, e));
                return b.absolute = l, void(a._isSplit = !0)
            }
            var X, T, B, ha, H, x, la, ma, q = b.span ? "span" : "div",
                ...
                ca = b.span ? "</span>" : "</div>",
                ia = !0,
                qa = b.specialChars ? "function" == typeof b.specialChars ? b.specialChars : h : null;
            ...
            X = d(a);
            x = -1 !== X.indexOf("<");
            !1 !== b.reduceWhiteSpace && (X = X.replace(p, " ").replace(n, ""));
            x && (X = X.split("<").join("{{LT}}"));
            ha = X.length;
            T = (" " === X.charAt(0) ? Y : "") + c();
            for (B = 0; ha > B; B++)
                if (H = X.charAt(B), qa && (ma = qa(X.substr(B), b.specialChars))) H = X.substr(B, ma || 1), T += V && " " !== H ? e() + H + "</" + q + ">" : H, B += ma - 1;
                else if (H === l && X.charAt(B - 1) !== l && B) {
                T += ia ? ca : "";
                for (ia = !1; X.charAt(B + 1) === l;) T += Y, B++;
                B === ha - 1 ? T += Y : ")" !== X.charAt(B + 1) && (T += Y + c(),
                    ia = !0)
            } else "{" === H && "{{LT}}" === X.substr(B, 6) ? (T += V ? e() + "{{LT}}</" + q + ">" : "{{LT}}", B += 5) : 55296 <= H.charCodeAt(0) && 56319 >= H.charCodeAt(0) || 65024 <= X.charCodeAt(B + 1) && 65039 >= X.charCodeAt(B + 1) ? (g = z(X.substr(B, 2)), la = z(X.substr(B + 2, 2)), m = 127462 <= g && 127487 >= g && 127462 <= la && 127487 >= la || 127995 <= la && 127999 >= la ? 4 : 2, T += V && " " !== H ? e() + X.substr(B, m) + "</" + q + ">" : X.substr(B, m), B += m - 1) : T += V && " " !== H ? e() + H + "</" + q + ">" : H;
            a.outerHTML = T + (ia ? ca : "");
            x && r(pa, "{{LT}}", "<")
        },
        a = m.prototype;
    a.split = function(a) {
        ...
        for (var b, c, d, m = this.elements.length, g = a.span ? "span" : "div", y = V(a.wordsClass, g), g = V(a.charsClass, g); - 1 < --m;) {
            d = this.elements[m];
            ...
            var h = a,
                ...
                w = h.wordDelimiter || " ",
                u = h.span ? "span" : "div",
                n = h.type || h.split || "chars,words,lines",
                A = p && -1 !== n.indexOf("lines") ? [] : null,
                M = -1 !== n.indexOf("words"),
                R = -1 !== n.indexOf("chars"),
                N = "absolute" === h.position || !0 === h.absolute,
                S = h.linesClass,
                O = -1 !==
                (S || "").indexOf("++"),
                Ga = [];
            A && 1 === d.children.length && d.children[0]._isSplit && (d = d.children[0]);
            O && (S = S.split("++").join(""));
            B = d.getElementsByTagName("*");
            H = B.length;
            la = [];
            for (n = 0; H > n; n++) la[n] = B[n];
            if (A || N)
                for (n = 0; H > n; n++) x = la[n], ((B = x.parentNode === d) || N || R && !M) && (pa = x.offsetTop, A && B && Math.abs(pa - Y) > xa && ("BR" !== x.nodeName || 0 === n) && (ma = [], A.push(ma), Y = pa), N && (x._x = x.offsetLeft, x._y = pa, x._w = x.offsetWidth, x._h = x.offsetHeight), A && ((x._isSplit && B || !R && B || M && B || !M && x.parentNode.parentNode === d && !x.parentNode._isSplit) &&
                    (ma.push(x), x._x -= aa, X(x, d, w) && (x._wordEnd = !0)), "BR" === x.nodeName && (x.nextSibling && "BR" === x.nextSibling.nodeName || 0 === n) && A.push([])));
            for (n = 0; H > n; n++) x = la[n], B = x.parentNode === d, "BR" !== x.nodeName ? (N && (ca = x.style, M || B || (x._x += x.parentNode._x, x._y += x.parentNode._y), ca.left = x._x + "px", ca.top = x._y + "px", ca.position = "absolute", ca.display = "block", ca.width = x._w + 1 + "px", ca.height = x._h + "px"), !M && R ? x._isSplit ? (x._next = x.nextSibling, x.parentNode.appendChild(x)) : x.parentNode._isSplit ? (x._parent = x.parentNode, !x.previousSibling &&
                ...
                ba.push(x) : R && !x._isSplit && (h.span && (x.style.display = "inline"), oa.push(x))) : A || N ? (x.parentNode && x.parentNode.removeChild(x), la.splice(n--, 1), H--) : M || d.appendChild(x);
            for (n = Ga.length; - 1 < --n;) Ga[n].parentNode.removeChild(Ga[n]);
            if (A) {
                N && (ia = f.createElement(u), d.appendChild(ia), qa = ia.offsetWidth + "px", pa = ia.offsetParent === d ? 0 : d.offsetLeft, d.removeChild(ia));
                ca = d.style.cssText;
                ...
                for (n = 0; n < A.length; n++) {
                    ma =
                        A[n];
                    ia = f.createElement(u);
                    ia.style.cssText = "display:block;text-align:" + ka + ";position:" + (N ? "absolute;" : "relative;");
                    S && (ia.className = S + (O ? n + 1 : ""));
                    t.push(ia);
                    H = ma.length;
                    for (B = 0; H > B; B++) "BR" !== ma[B].nodeName && (x = ma[B], ia.appendChild(x), Y && x._wordEnd && ia.appendChild(f.createTextNode(" ")), N && (0 === B && (ia.style.top = x._y + "px", ia.style.left = aa + pa + "px"), x.style.top = "0px", pa && (x.style.left = x._x - pa + "px")));
                    0 === H ? ia.innerHTML = "&nbsp;" : M || R || (T(ia), r(ia, String.fromCharCode(160), " "));
                    N && (ia.style.width = qa,
                        ia.style.height = x._h + "px");
                    d.appendChild(ia)
                }
                d.style.cssText = ca
            }
            N && (b > d.clientHeight && (d.style.height = b - Ca + "px", d.clientHeight < b && (d.style.height = b + E + "px")), c > d.clientWidth && (d.style.width = c - Fa + "px", d.clientWidth < c && (d.style.width = c + va + "px")));
            q(l, oa);
            M && q(z, ba);
            q(p, t)
        }
    ...
    a.revert = function() {
        ...
        for (var a = this._originals.length; - 1 < --a;) this.elements[a].innerHTML =
            this._originals[a];
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    var b = function(a) {
        ...
        f = _gsScope._gsDefine.plugin({
            ...
            API: 2,
            version: "0.6.2",
            init: function(a, c, f, l) {
                var h = a.nodeName.toUpperCase();
                if ("function" == typeof c && (c = c(l, a)), this._svg = a.getBBox && ("TEXT" === h || "TSPAN" === h), !("innerHTML" in a || this._svg)) return !1;
                ...
                (this._runBackwards = !0 === f.vars.runBackwards) && (h = this._original, this._original = this._text, this._text = h);
                ...
                h = this._original.length - this._text.length;
                a = 0 > h ? this._original : this._text;
                this._fillChar = c.fillChar || (c.padSpace ? "&nbsp;" : "");
                for (0 > h && (h = -h); - 1 < --h;) a.push(this._fillChar);
                return !0
            },
            set: function(a) {
                1 <
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(b, c, a) {
        ...
        h.render = function(b, c, d) {
            ...
            if (!this._initted) {
                ...
                if (!d && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration)) return this._time = G, this._totalTime = Q, this._rawPrevTime = D, this._cycle = J, g.lazyTweens.push(this), void(this._lazy = [b, c]);
                !this._time || f || p ? f && this._ease._calcEnd && !p && (this.ratio = this._ease.getRatio(0 === this._time ? 0 : 1)) : this.ratio = this._ease.getRatio(this._time / W)
            }!1 !== this._lazy && (this._lazy = !1);
            this._active || !this._paused && this._time !== G &&
                0 <= b && (this._active = !0);
            0 !== Q || (2 === this._initted && 0 < b && this._init(), this._startAt && (0 <= b ? this._startAt.render(b, !0, d) : e || (e = "_dummyGS")), !this.vars.onStart || 0 === this._totalTime && 0 !== W || !c && this._callback("onStart"));
            for (h = this._firstPT; h;) h.f ? h.t[h.p](h.c * this.ratio + h.s) : h.t[h.p] = h.c * this.ratio + h.s, h = h._next;
            this._onUpdate && (0 > b && this._startAt && this._startTime && this._startAt.render(b, !0, d), c || (this._totalTime !== Q || e) && this._callback("onUpdate"));
            this._cycle !== J && (c || this._gc || this.vars.onRepeat &&
        ...
        e.staggerTo = e.allTo = function(b, c, r, g, h, z, p) {
            g = g || 0;
            var B, I, F, C, K = 0,
                G = [],
                Q = function() {
                    r.onComplete && r.onComplete.apply(r.onCompleteScope || this, arguments);
                    h.apply(p || r.callbackScope || this, z || n)
                },
                J = r.cycle,
                W = r.startAt && r.startAt.cycle;
            l(b) || ("string" == typeof b && (b = a.selector(b) || b), k(b) && (b = d(b)));
            b = b || [];
            ...
            for (F = 0; B >= F; F++) {
                I = {};
                for (C in r) I[C] = r[C];
                if (J && (f(I, b, F), null != I.duration &&
                        (c = I.duration, delete I.duration)), W) {
                    W = I.startAt = {};
                    for (C in r.startAt) W[C] = r.startAt[C];
                    f(I.startAt, b, F)
                }
                I.delay = K + (I.delay || 0);
                F === B && h && (I.onComplete = Q);
                G[F] = new e(b[F], c, I);
                K += g
            }
            return G
        ...
        e.staggerFromTo = e.allFromTo = function(a, b, c, d, f, g, h, k) {
            return d.startAt = c, d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender, e.staggerTo(a, b, d, f, g, h, k)
        };
        e.delayedCall =
            function(a, b, c, d, f) {
                return new e(b, 0, {
        ...
        var p = function(b, c) {
                for (var d = [], f = 0, e = b._first; e;) e instanceof a ? d[f++] = e : (c && (d[f++] = e), d = d.concat(p(e, c)), f = d.length), e = e._next;
                return d
            },
            z = e.getAllTweens = function(a) {
                return p(b._rootTimeline, a).concat(p(b._rootFramesTimeline,
                    a))
            };
        e.killAll = function(a, b, d, f) {
            ...
            var e, g, h = z(0 != f),
                k = h.length,
                l = b && d && f;
            for (g = 0; k > g; g++) f = h[g], (l || f instanceof c || (e = f.target === f.vars.onComplete) && d || b && !e) && (a ? f.totalTime(f._reversed ? 0 : f.totalDuration()) : f._enabled(!1, !1))
        };
        e.killChildTweensOf = function(b, c) {
            if (null != b) {
                var f, q, h, z = g.tweenLookup;
                if ("string" == typeof b && (b = a.selector(b) || b), k(b) && (b = d(b)), l(b))
                    for (q = b.length; - 1 < --q;) e.killChildTweensOf(b[q], c);
                else {
                    f = [];
                    for (h in z)
                        for (q = z[h].target.parentNode; q;) q ===
                            b && (f = f.concat(z[h].tweens)), q = q.parentNode;
                    h = f.length;
                    for (q = 0; h > q; q++) c && f[q].totalTime(f[q].totalDuration()), f[q]._enabled(!1, !1)
                }
            }
        };
        var B = function(a, b, d, f) {
            ...
            d = !1 !== d;
            f = !1 !== f;
            for (var e, g = z(f), h = b && d && f, k = g.length; - 1 < --k;) f = g[k], (h || f instanceof c || (e = f.target === f.vars.onComplete) && d || b && !e) && f.paused(a)
        };
        ...
        }, h.progress = function(a, b) {
            return arguments.length ? this.totalTime(this.duration() * (this._yoyo && 0 !== (1 & this._cycle) ? 1 - a : a) + this._cycle * (this._duration + this._repeatDelay), b) : this._time / this.duration()
        }, h.totalProgress = function(a, b) {
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(b, c, a) {
        var d = function(a) {
            ...
            f = d.prototype = new c;
        return d.version = "2.0.1", f.constructor = d, f.kill()._gc = f._forcingPlayhead = f._hasPause = !1, f.to = function(b, c, d, f) {
            ...
            }, f.staggerTo = function(b, c, f, e, h, k, l, n) {
                n = new d({
                    onComplete: k,
                    onCompleteParams: l,
                    callbackScope: n,
                ...
                for (l = 0; l < b.length; l++) k = p(f), k.startAt && (k.startAt = p(k.startAt), k.startAt.cycle && z(k.startAt, b, l)), B && (z(k, b, l), null != k.duration && (c = k.duration, delete k.duration)), n.to(b[l], c, k, l * e);
                return this.add(n, h)
            }, f.staggerFrom = function(a, b, c, d, f, e, g, h) {
                return c.immediateRender = 0 != c.immediateRender, c.runBackwards = !0, this.staggerTo(a, b, c, d, f, e, g, h)
            }, f.staggerFromTo = function(a, b, c, d, f, e, g, h, k) {
                return d.startAt = c, d.immediateRender = 0 != d.immediateRender &&
                    0 != c.immediateRender, this.staggerTo(a, b, d, f, e, g, h, k)
                ...
                var f, e, g, h, k = new d(b),
                    l = k._timeline;
                null == c && (c = !0);
                l._remove(k, !0);
                k._startTime = 0;
                k._rawPrevTime = k._time = k._totalTime = l._time;
                for (g =
                    l._first; g;) h = g._next, c && g instanceof a && g.target === g.vars.onComplete || (e = g._startTime - g._delay, 0 > e && (f = 1), k.add(g, e)), g = h;
                return l.add(k, 0), f && k.totalDuration(), k
            }, f.add = function(f, e, g, h) {
                var l, z, p;
                if ("number" != typeof e && (e = this._parseTimeOrLabel(e, 0, !0, f)), !(f instanceof b)) {
                    if (f instanceof Array || f && f.push && k(f)) {
                        ...
                        h = h || 0;
                        l = f.length;
                        for (z = 0; l > z; z++) k(p = f[z]) && (p = new d({
                            tweens: p
                        })), this.add(p, e), "string" != typeof p && "function" != typeof p && ("sequence" === g ? e = p._startTime + p.totalDuration() /
                            p._timeScale : "start" === g && (p._startTime -= p.delay())), e += h;
                ...
                if (c.prototype.add.call(this, f, e), f._time && f.render((this.rawTime() - f._startTime) * f._timeScale, !1, !1), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())
                    for (g = this, f = g.rawTime() > f._startTime; g._timeline;) f &&
                        g._timeline.smoothChildTiming ? g.totalTime(g._totalTime, !0) : g._gc && g._enabled(!0, !1), g = g._timeline;
                return this
            }, f.remove = function(a) {
                if (a instanceof b) {
                    this._remove(a, !1);
                ...
                return "string" == typeof a ? this.removeLabel(a) :
                    this.kill(null, a)
            ...
            }, f._parseTimeOrLabel = function(a, c, d, f) {
                var e;
                ...
                if (c = c || 0, "string" != typeof a || !isNaN(a) && null == this._labels[a]) null == a && (a = f);
                    ...
                    if (e = a.indexOf("="), -1 === e) return null == this._labels[a] ? d ? this._labels[a] = f + c : c : this._labels[a] + c;
                    c = parseInt(a.charAt(e -
                        1) + "1", 10) * Number(a.substr(e + 1));
                ...
                var d, f, e, g, k, z, p, n = this._time,
                    B = this._dirty ? this.totalDuration() : this._totalDuration,
                    V = this._startTime,
                    J = this._timeScale,
                    W = this._paused;
                if (n !== this._time && (a += this._time - n), a >= B - 1E-7 && 0 <= a) this._totalTime = this._time = B, this._reversed || this._hasPausedChild() || (f = !0, g = "onComplete", k = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= a && -1E-7 <= a || 0 > this._rawPrevTime || 1E-10 === this._rawPrevTime) && this._rawPrevTime !== a && this._first && (k = !0, 1E-10 < this._rawPrevTime && (g = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : 1E-10, a = B + 1E-4;
                else if (1E-7 > a)
                    if (this._totalTime =
                        this._time = 0, (0 !== n || 0 === this._duration && 1E-10 !== this._rawPrevTime && (0 < this._rawPrevTime || 0 > a && 0 <= this._rawPrevTime)) && (g = "onReverseComplete", f = this._reversed), 0 > a) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (k = f = !0, g = "onReverseComplete") : 0 <= this._rawPrevTime && this._first && (k = !0), this._rawPrevTime = a;
                    else {
                        if (this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : 1E-10, 0 === a && f)
                    ...
                    if (this._hasPause && !this._forcingPlayhead && !b) {
                        if (a >= n)
                            for (d = this._first; d && d._startTime <= a && !z;) d._duration || "isPause" !== d.data || d.ratio || 0 === d._startTime && 0 === this._rawPrevTime || (z = d), d = d._next;
                        else
                            for (d = this._last; d && d._startTime >= a && !z;) d._duration || "isPause" === d.data && 0 < d._rawPrevTime && (z = d), d = d._prev;
                        z && (this._time = a = z._startTime, this._totalTime = a + this._cycle * (this._totalDuration + this._repeatDelay))
                    }
                    this._totalTime = this._time = this._rawPrevTime = a
                }
                if (this._time !== n && this._first || c ||
                    k || z) {
                    if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== n && 0 < a && (this._active = !0), 0 === n && this.vars.onStart && (0 === this._time && this._duration || b || this._callback("onStart")), p = this._time, p >= n)
                        for (d = this._first; d && (e = d._next, p === this._time && (!this._paused || W));)(d._active || d._startTime <= p && !d._paused && !d._gc) && (z === d && this.pause(), d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) * d._timeScale, b,
                            c)), d = e;
                    else
                        for (d = this._last; d && (e = d._prev, p === this._time && (!this._paused || W));) {
                            if (d._active || d._startTime <= n && !d._paused && !d._gc) {
                                if (z === d) {
                                    for (z = d._prev; z && z.endTime() > this._time;) z.render(z._reversed ? z.totalDuration() - (a - z._startTime) * z._timeScale : (a - z._startTime) * z._timeScale, b, c), z = z._prev;
                                    z = null;
                                    this.pause()
                                }
                    ...
                    this._onUpdate && (b || (l.length && h(),
                        this._callback("onUpdate")));
                    g && (this._gc || (V === this._startTime || J !== this._timeScale) && (0 === this._time || B >= this.totalDuration()) && (f && (l.length && h(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !b && this.vars[g] && this._callback(g)))
                }
                ...
                f = f || -9999999999;
                for (var e = [], g = this._first, h = 0; g;) g._startTime < f || (g instanceof a ? !1 !== c && (e[h++] = g) : (!1 !== d && (e[h++] = g), !1 !== b && (e = e.concat(g.getChildren(!0, c, d)), h = e.length))), g = g._next;
                return e
                ...
                e && this._enabled(!0, !0);
                d = a.getTweensOf(b);
                for (f = d.length; - 1 < --f;)(d[f].timeline === this || c && this._contains(d[f])) && (g[h++] = d[f]);
            ...
            f.invalidate = function() {
                ...
                if (!arguments.length) {
                    if (this._dirty) {
                        ...
                        for (var f = 999999999999; c;) b = c._prev, c._dirty && c.totalDuration(), c._startTime > f && this._sortChildren && !c._paused && !this._calculatingDuration ? (this._calculatingDuration = 1, this.add(c, c._startTime - c._delay), this._calculatingDuration = 0) : f = c._startTime, 0 > c._startTime && !c._paused && (d -= c._startTime, this._timeline.smoothChildTiming && (this._startTime += c._startTime / this._timeScale,
                            this._time -= c._startTime, this._totalTime -= c._startTime, this._rawPrevTime -= c._startTime), this.shiftChildren(-c._startTime, !1, -9999999999), f = 0), c = c._startTime + c._totalDuration / c._timeScale, c > d && (d = c), c = b;
                ...
                return b.prototype.paused.apply(this,
                    arguments)
    ...
    _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(b, c, a) {
        var d = function(a) {
                b.call(this, a);
                this._repeat =
                    this.vars.repeat || 0;
            ...
            l = new a(null, null, 1, 0);
        a = d.prototype = new b;
        return a.constructor = d, a.kill()._gc = !1, d.version = "2.0.1", a.invalidate = function() {
            ...
            function(a, b, d, f) {
                ...
                this._gc && this._enabled(!0, !1);
                var d, f, k, m, r, l, y, X = this._time,
                    ...
                    G = this._paused,
                    Q = this._cycle;
                if (X !== this._time && (a += this._time - X), a >= T - 1E-7 && 0 <= a) this._locked ||
                    (this._totalTime = T, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (f = !0, m = "onComplete", r = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= a && -1E-7 <= a || 0 > K || 1E-10 === K) && K !== a && this._first && (r = !0, 1E-10 < K && (m = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : 1E-10, this._yoyo && 0 !== (1 & this._cycle) ? this._time = a = 0 : (this._time = L, a = L + 1E-4);
                else if (1E-7 > a)
                    if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== X || 0 === L && 1E-10 !==
                            K && (0 < K || 0 > a && 0 <= K) && !this._locked) && (m = "onReverseComplete", f = this._reversed), 0 > a) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (r = f = !0, m = "onReverseComplete") : 0 <= K && this._first && (r = !0), this._rawPrevTime = a;
                    else {
                        if (this._rawPrevTime = L || !b || a || this._rawPrevTime === a ? a : 1E-10, 0 === a && f)
                            for (d = this._first; d && 0 === d._startTime;) d._duration || (f = !1), d = d._next;
                        a = 0;
                        this._initted || (r = !0)
                    }
                else if (0 === L && 0 > K && (r = !0), this._time = this._rawPrevTime = a, this._locked || (this._totalTime = a, 0 !== this._repeat &&
                        (d = L + this._repeatDelay, this._cycle = this._totalTime / d >> 0, 0 !== this._cycle && this._cycle === this._totalTime / d && a >= I && this._cycle--, this._time = this._totalTime - this._cycle * d, this._yoyo && 0 !== (1 & this._cycle) && (this._time = L - this._time), this._time > L ? (this._time = L, a = L + 1E-4) : 0 > this._time ? this._time = a = 0 : a = this._time)), this._hasPause && !this._forcingPlayhead && !b) {
                    if (a = this._time, a >= X || this._repeat && Q !== this._cycle)
                        for (d = this._first; d && d._startTime <= a && !l;) d._duration || "isPause" !== d.data || d.ratio || 0 === d._startTime &&
                            0 === this._rawPrevTime || (l = d), d = d._next;
                    else
                        for (d = this._last; d && d._startTime >= a && !l;) d._duration || "isPause" === d.data && 0 < d._rawPrevTime && (l = d), d = d._prev;
                    l && l._startTime < L && (this._time = a = l._startTime, this._totalTime = a + this._cycle * (this._totalDuration + this._repeatDelay))
                }
                if (this._cycle !== Q && !this._locked) {
                    d = this._yoyo && 0 !== (1 & Q);
                    var J = d === (this._yoyo && 0 !== (1 & this._cycle)),
                        W = this._totalTime,
                        D = this._cycle,
                        ea = this._rawPrevTime,
                        Z = this._time;
                    if ((this._totalTime = Q * L, this._cycle < Q ? d = !d : this._totalTime += L, this._time =
                            X, this._rawPrevTime = 0 === L ? K - 1E-4 : K, this._cycle = Q, this._locked = !0, X = d ? 0 : L, this.render(X, b, 0 === L), b || this._gc || this.vars.onRepeat && (this._cycle = D, this._locked = !1, this._callback("onRepeat")), X !== this._time) || (J && (this._cycle = Q, this._locked = !0, X = d ? L + 1E-4 : -1E-4, this.render(X, !0, !1)), this._locked = !1, this._paused && !G)) return;
                    this._time = Z;
                    this._totalTime = W;
                    this._cycle = D;
                    this._rawPrevTime = ea
                }
                if (!(this._time !== X && this._first || c || r || l)) return void(I !== this._totalTime && this._onUpdate && (b || this._callback("onUpdate")));
                if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== I && 0 < a && (this._active = !0), 0 === I && this.vars.onStart && (0 === this._totalTime && this._totalDuration || b || this._callback("onStart")), y = this._time, y >= X)
                    for (d = this._first; d && (k = d._next, y === this._time && (!this._paused || G));)(d._active || d._startTime <= this._time && !d._paused && !d._gc) && (l === d && this.pause(), d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (a - d._startTime) * d._timeScale, b, c) : d.render((a - d._startTime) *
                        d._timeScale, b, c)), d = k;
                else
                    for (d = this._last; d && (k = d._prev, y === this._time && (!this._paused || G));) {
                ...
                m && (this._locked || this._gc || (F === this._startTime || C !== this._timeScale) && (0 === this._time || T >= this.totalDuration()) && (f && (e.length && g(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !b && this.vars[m] && this._callback(m)))
    ...
    (function() {
        var b = 180 / Math.PI,
            ...
            k = function(a, b, c, d) {
                ...
                var h = (h + c) / 2,
                    n = (h - b) / 8;
                return f.b = l + (a - l) / 4, e.b = b + n, f.c = e.a = (f.b + e.b) / 2, e.c = g.a = (b + h) / 2, g.b = h - n, k.b = c + (d - c) / 4, g.c = k.a = (g.b + k.b) / 2, [f, e, g, k]
            },
            l = function(b, e, h, l, m, r) {
                var q, y, n, T, L = {},
                    I = [],
                    F = r || b[0];
                ...
                null == e && (e = 1);
                for (y in b[0]) I.push(y);
                if (1 < b.length) {
                    n = b[b.length - 1];
                    T = !0;
                    for (q = I.length; - 1 < --q;)
                        if (y = I[q], .05 < Math.abs(F[y] - n[y])) {
                            T = !1;
                            break
                        }
                    T && (b = b.concat(), r && b.unshift(r), b.push(b[1]), r = b[b.length - 3])
                }
                ...
                for (q = I.length; - 1 < --q;) {
                    ...
                    var F = b,
                        ...
                        Z = [];
                    if (G)
                        for (F = [G].concat(F), J = F.length; - 1 < --J;) "string" == typeof(W = F[J][C]) && "=" === W.charAt(1) && (F[J][C] = G[C] + Number(W.charAt(0) +
                            W.substr(2)));
                    if (Q = F.length - 2, 0 > Q) F = (Z[0] = new g(F[0][C], 0, 0, F[0][C]), Z);
                    else {
                        for (J = 0; Q > J; J++) W = F[J][C], D = F[J + 1][C], Z[J] = new g(W, 0, 0, D), K && (ea = F[J + 2][C], c[J] = (c[J] || 0) + (D - W) * (D - W), a[J] = (a[J] || 0) + (ea - D) * (ea - D));
                        F = (Z[J] = new g(F[J][C], 0, 0, F[J + 1][C]), Z)
                    }
                    L[n] = F
                }
                ...
                if (!l) {
                    for (q = I.length; - 1 < --q;)
                        if (f[y])
                            for (b = L[I[q]], n = b.length - 1, m = 0; n > m; m++) r = b[m + 1].da / a[m] + b[m].da / c[m] || 0, d[m] = (d[m] || 0) + r * r;
                ...
                for (m = h ? 4 : 1; - 1 < --q;) {
                    ...
                    J.ca = J.c - J.a;
                    J.ba = Y - J.a;
                    F && (D = k(J.a, Y, J.c, J.d), r.splice(ma, 1, D[0], D[1], D[2], D[3]));
            ...
            h = _gsScope._gsDefine.plugin({
                ...
                init: function(a, b, c) {
                    ...
                    for (e = this._props.length; - 1 < --e;) d = this._props[e], this._overwriteProps.push(d), f = this._func[d] = "function" == typeof a[d], T[d] = f ? a[d.indexOf("set") || "function" != typeof a["get" + d.substr(3)] ? d : "get" + d.substr(3)]() : parseFloat(a[d]), h || T[d] !== n[0][d] && (h = T);
                    if ("cubic" !== b.type && "quadratic" !== b.type && "soft" !== b.type) T =
                        l(n, isNaN(b.curviness) ? 1 : b.curviness, !1, "thruBasic" === b.type, b.correlate, h);
                    else {
                        e = n;
                        var n = (n = b.type) || "soft",
                            L, I, F, C, K, G, Q;
                        ...
                        var J = "soft" === n,
                            W = [];
                        if (J && T && (e = [T].concat(e)), null == e || e.length < h + 1) throw "invalid Bezier data";
                        for (L in e[0]) W.push(L);
                        for (C = W.length; - 1 < --C;) {
                            L = W[C];
                            b[L] = f = [];
                            Q = 0;
                            G = e.length;
                            for (K = 0; G > K; K++) n = null == T ? e[K][L] : "string" == typeof(I = e[K][L]) && "=" === I.charAt(1) ? T[L] + Number(I.charAt(0) + I.substr(2)) : Number(I), J && 1 < K && G - 1 > K && (f[Q++] = (n + f[Q - 2]) / 2), f[Q++] = n;
                            G =
                                Q - h + 1;
                            for (K = Q = 0; G > K; K += h) n = f[K], L = f[K + 1], I = f[K + 2], F = 2 === h ? 0 : f[K + 3], f[Q++] = I = 3 === h ? new g(n, L, I, F) : new g(n, (2 * L + n) / 3, (2 * L + I) / 3, I);
                            f.length = Q
                        }
                        T = b
                    }
                    if (this._beziers = T, this._segCount = this._beziers[d].length, this._timeRes) {
                        ...
                        for (k in f) {
                            ...
                            var D = void 0,
                                ...
                                W = 1 / G;
                            for (F = C.length; - 1 < --F;)
                                for (Z = C[F], ea = Z.a, Q = Z.d - ea, J = Z.c - ea, Z = Z.b - ea, ea = 0, na = 1; G >= na; na++) D = W * na, ha = 1 - D, D = ea - (ea = (D * D * Q + 3 * ha * (D *
                                    J + ha * Z)) * D), ha = F * G + na - 1, K[ha] = (K[ha] || 0) + D * D
                        }
                        f = T.length;
                        for (k = 0; f > k; k++) I += Math.sqrt(T[k]), C = k % d, n[C] = I, C === b && (e += I, C = k / d >> 0, h[C] = n, L[C] = e, I = 0, n = []);
                        this._length = e;
                        this._lengths = L;
                        this._segments = h;
                ...
                set: function(a) {
                    ...
                    if (this._autoRotate) {
                        var L, I, F, C, K, G, Q = this._autoRotate;
                        for (f = Q.length; - 1 < --f;) a = Q[f][2], K = Q[f][3] || 0, G = !0 === Q[f][4] ? 1 : b, e = this._beziers[Q[f][0]], d = this._beziers[Q[f][1]], e &&
                            d && (e = e[c], d = d[c], L = e.a + (e.b - e.a) * g, F = e.b + (e.c - e.b) * g, L += (F - L) * g, F += (e.c + (e.d - e.c) * g - F) * g, I = d.a + (d.b - d.a) * g, C = d.b + (d.c - d.b) * g, I += (C - I) * g, C += (d.c + (d.d - d.c) * g - C) * g, k = n ? Math.atan2(C - I, F - L) * G + K : this._initialRotations[f], this._mod[a] && (k = this._mod[a](k, l)), h[a] ? l[a](k) : l[a] = k)
                    }
                }
            }),
            n = h.prototype;
        h.bezierThrough = l;
        h.cubicToQuadratic = k;
        h._autoCSS = !0;
        h.quadraticToCubic = function(a, b, c) {
                ...
                a._registerComplexSpecialProp("bezier", {
                    parser: function(a, f, e, g, k, l) {
                        ...
                        var n, p, F = f.values,
                            ...
                            G = {};
                        if (0 > C) return k;
                        for (e = 0; C >= e; e++) p = b(a, F[e], g, k, l, C !== e), K[e] = p.end;
                        for (n in f) G[n] = f[n];
                        return G.values = K, k = new d(a, "bezier", 0, 0, p.pt, 2), k.data = p, k.plugin = l, k.setRatio = c, 0 === G.autoRotate && (G.autoRotate = !0), !G.autoRotate || G.autoRotate instanceof Array || (e = !0 === G.autoRotate ? 0 : Number(G.autoRotate), G.autoRotate =
                            null != p.end.left ? [
                                ["left", "top", "rotation", e, !1]
                            ] : null != p.end.x ? [
                                ["x", "y", "rotation", e, !1]
                            ] : !1), G.autoRotate && (g._transform || g._enableTransforms(!1), p.autoRotate = g._target._gsTransform, p.proxy.rotation = p.autoRotate.rotation || 0, g._overwriteProps.push("rotation")), l._onInitTween(p.proxy, G, g._tween), k
                    }
                })
            }
        };
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(b, c) {
        ...
        var n, p, z, B, V, m, r, q, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            ...
            E = function() {
                var a = aa.indexOf("Android"),
                    b = ia("a");
                return z = -1 !== aa.indexOf("Safari") && -1 === aa.indexOf("Chrome") && (-1 === a || 3 < parseFloat(aa.substr(a + 8, 2))), V = z && 6 > parseFloat(aa.substr(aa.indexOf("Version/") + 8, 2)), B = -1 !== aa.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(aa) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(aa)) && (m = parseFloat(RegExp.$1)), b ? (b.style.cssText =
                    "top:1px;opacity:.55;", /^0.55/.test(b.style.opacity)) : !1
            }(),
            va = function(a) {
                return F.test("string" == typeof a ? a : (a.currentStyle ? a.currentStyle.filter : a.style.filter) || "") ? parseFloat(RegExp.$1) / 100 : 1
            },
            Ca = "",
            Fa = "",
            xa = function(a, b) {
            ...
            ba = g.getStyle = function(a, b, c, d, f) {
                var e;
                return E || "opacity" !== b ? (!d && a.style[b] ? e = a.style[b] : (c = c || oa(a)) ? e = c[b] || c.getPropertyValue(b) || c.getPropertyValue(b.replace(Q, "-$1").toLowerCase()) : a.currentStyle && (e = a.currentStyle[b]), null == f || e && "none" !== e && "auto" !== e && "auto auto" !== e ? e : f) : va(a)
            },
            t = ka.convertToPixels = function(a, b, d, f, e) {
                if ("px" === f || !f && "lineHeight" !== b) return d;
                if ("auto" === f || !d) return 0;
                var k, Ia, r, h = ea.test(b),
                    l = a;
                k = qa.style;
                var w = 0 > d,
                    u = 1 === d;
                if (w && (d = -d), u && (d *= 100), "lineHeight" !== b || f)
                    if ("%" === f && -1 !== b.indexOf("border")) k = d / 100 * (h ? a.clientWidth : a.clientHeight);
                        ...
                        if (k.cssText = "border:0 solid red;position:" + ba(a, "position") + ";line-height:0;", "%" !== f && l.appendChild && "v" !== f.charAt(0) && "rem" !== f) k[h ? "borderLeftWidth" : "borderTopWidth"] = d + f;
                            ...
                            if (l = a.parentNode || ca.body, -1 !== ba(l, "display").indexOf("flex") && (k.position = "absolute"), Ia = l._gsCache, r = c.ticker.frame, Ia && h && Ia.time === r) return Ia.width * d / 100;
                            k[h ? "width" : "height"] = d +
                                f
                        }
                        l.appendChild(qa);
                        ...
                        l.removeChild(qa);
                        h && "%" === f && !1 !== g.cacheWidths && (Ia = l._gsCache = l._gsCache || {}, Ia.time = r, Ia.width = k / d * 100);
                        0 !== k || e || (k = t(a, b, d, f, !0))
                    }
                else Ia = oa(a).lineHeight, a.style.lineHeight = d, k = parseFloat(oa(a).lineHeight), a.style.lineHeight = Ia;
                return u && (k /= 100), w ? -k : k
            },
            w = ka.calculateOffset = function(a, b, c) {
                if ("absolute" !== ba(a, "position", c)) return 0;
                var d = "left" === b ? "Left" : "Top";
                c = ba(a, "margin" + d, c);
                return a["offset" + d] - (t(a, b, parseFloat(c),
                    c.replace(I, "")) || 0)
            },
            u = function(a, b) {
                var c, d, f, e = {};
                if (b = b || oa(a, null))
                    if (c = b.length)
                        for (; - 1 < --c;) f = b[c], -1 !== f.indexOf("-transform") && mb !== f || (e[f.replace(J, D)] = b.getPropertyValue(f));
                    else
                        for (c in b) - 1 !== c.indexOf("Transform") && wa !== c || (e[c] = b[c]);
                else if (b = a.currentStyle || a.style)
                    for (c in b) "string" == typeof c && void 0 === e[c] && (e[c.replace(J, D)] = b[c]);
                return E || (e.opacity = va(a)), d = Ja(a, b, !1), e.rotation = d.rotation, e.skewX = d.skewX, e.scaleX = d.scaleX, e.scaleY = d.scaleY, e.x = d.x, e.y = d.y, Aa && (e.z = d.z, e.rotationX =
                    d.rotationX, e.rotationY = d.rotationY, e.scaleZ = d.scaleZ), e.filters && delete e.filters, e
            },
            A = function(a, b, c, d, f) {
                var e, g, t, k = {},
                    r = a.style;
                for (g in c) "cssText" !== g && "length" !== g && isNaN(g) && (b[g] !== (e = c[g]) || f && f[g]) && -1 === g.indexOf("Origin") && ("number" == typeof e || "string" == typeof e) && (k[g] = "auto" !== e || "left" !== g && "top" !== g ? "" !== e && "auto" !== e && "none" !== e || "string" != typeof b[g] || "" === b[g].replace(L, "") ? e : 0 : w(a, g), void 0 !== r[g] && (t = new ja(r, g, r[g], t)));
                if (d)
            ...
            R = ["marginLeft", "marginRight", "marginTop", "marginBottom"],
            N = function(a, b) {
                ...
                if (3 < d.length && !b) {
                    ...
                    a = [];
                    for (c = 0; c < d.length; c++) a.push(N(d[c]));
                    return a.join(",")
                }
                return null ==
                    f ? f = "center" === c ? "50%" : "0" : "center" === f && (f = "50%"), ("center" === c || isNaN(parseFloat(c)) && -1 === (c + "").indexOf("=")) && (c = "50%"), a = c + " " + f + (2 < d.length ? " " + d[2] : ""), b && (b.oxp = -1 !== c.indexOf("%"), b.oyp = -1 !== f.indexOf("%"), b.oxr = "=" === c.charAt(1), b.oyr = "=" === f.charAt(1), b.ox = parseFloat(c.replace(L, "")), b.oy = parseFloat(f.replace(L, "")), b.v = a), b || a
            },
            S = function(a, b) {
                return "function" == typeof a && (a = a(q, r)), "string" == typeof a && "=" === a.charAt(1) ? parseInt(a.charAt(0) + "1", 10) * parseFloat(a.substr(2)) : parseFloat(a) -
                    parseFloat(b) || 0
            },
            O = function(a, b) {
                return "function" == typeof a && (a = a(q, r)), null == a ? b : "string" == typeof a && "=" === a.charAt(1) ? parseInt(a.charAt(0) + "1", 10) * parseFloat(a.substr(2)) + b : parseFloat(a) || 0
            },
            Ga = function(a, b, c, d) {
                var f, e, g, t;
                return "function" == typeof a && (a = a(q, r)), null == a ? g = b : "number" == typeof a ? g = a : (f = a.split("_"), t = "=" === a.charAt(1), e = (t ? parseInt(a.charAt(0) + "1", 10) * parseFloat(f[0].substr(2)) : parseFloat(f[0])) * (-1 === a.indexOf("rad") ? 1 : la) - (t ? 0 : b), f.length && (d && (d[c] = b + e), -1 !== a.indexOf("short") &&
                    (e %= 360, e !== e % 180 && (e = 0 > e ? e + 360 : e - 360)), -1 !== a.indexOf("_cw") && 0 > e ? e = (e + 3599999999640) % 360 - 360 * (e / 360 | 0) : -1 !== a.indexOf("ccw") && 0 < e && (e = (e - 3599999999640) % 360 - 360 * (e / 360 | 0))), g = b + e), 1E-6 > g && -1E-6 < g && (g = 0), g
            },
            ua = {
                aqua: [0, 255, 255],
                lime: [0, 255, 0],
            ...
            Ba = g.parseColor = function(a, b) {
                var c, d, f, e, g, t, k, r, h, l, w;
                if (a)
                    if ("number" == typeof a) c = [a >> 16, a >> 8 & 255, 255 & a];
                    else {
                        if ("," === a.charAt(a.length - 1) && (a = a.substr(0, a.length - 1)), ua[a]) c = ua[a];
                        else if ("#" === a.charAt(0)) 4 === a.length && (d = a.charAt(1), f = a.charAt(2), e = a.charAt(3), a = "#" + d + d + f + f + e + e), a = parseInt(a.substr(1), 16), c = [a >> 16,
                            a >> 8 & 255, 255 & a
                        ];
                        else if ("hsl" === a.substr(0, 3))
                            if (c = w = a.match(y), b) {
                                if (-1 !== a.indexOf("=")) return a.match(X)
                            } else g = Number(c[0]) % 360 / 360, t = Number(c[1]) / 100, k = Number(c[2]) / 100, f = .5 >= k ? k * (t + 1) : k + t - k * t, d = 2 * k - f, 3 < c.length && (c[3] = Number(c[3])), c[0] = La(g + 1 / 3, d, f), c[1] = La(g, d, f), c[2] = La(g - 1 / 3, d, f);
                        else c = a.match(y) || ua.transparent;
                        c[0] = Number(c[0]);
                        c[1] = Number(c[1]);
                        c[2] = Number(c[2]);
                ...
                return b && !w && (d = c[0] / 255, f = c[1] / 255, e = c[2] / 255, r = Math.max(d, f, e), h = Math.min(d,
                    f, e), k = (r + h) / 2, r === h ? g = t = 0 : (l = r - h, t = .5 < k ? l / (2 - r - h) : l / (r + h), g = r === d ? (f - e) / l + (e > f ? 6 : 0) : r === f ? (e - d) / l + 2 : (d - f) / l + 4, g *= 60), c[0] = g + .5 | 0, c[1] = 100 * t + .5 | 0, c[2] = 100 * k + .5 | 0), c
            },
            Ta = function(a, b) {
                var c, d, f, e = a.match(v) || [],
                    g = 0,
                    t = "";
                if (!e.length) return a;
                for (c = 0; c < e.length; c++) d = e[c], f = a.substr(g, a.indexOf(d, g) - g), g += f.length + d.length, d = Ba(d, b), 3 === d.length && d.push(1), t += f + (b ? "hsla(" + d[0] + "," + d[1] + "%," + d[2] + "%," + d[3] : "rgba(" + d.join(",")) + ")";
                return t + a.substr(g)
            },
            v = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
        for (h in ua) v += "|" + h + "\\b";
        v = new RegExp(v + ")", "gi");
        g.colorStringFilter = function(a) {
            var b, c = a[0] + " " + a[1];
            v.test(c) && (b = -1 !== c.indexOf("hsl(") || -1 !== c.indexOf("hsla("), a[0] = Ta(a[0], b), a[1] = Ta(a[1], b));
            v.lastIndex = 0
        };
        ...
        var U = function(a, b, c, d) {
                ...
                var f, e = b ? (a.match(v) || [""])[0] : "",
                    g = a.split(e).join("").match(T) || [],
                    t = a.substr(0, a.indexOf(g[0])),
                ...
                return h ? f = b ? function(a) {
                    ...
                    if ("number" == typeof a) a += l;
                        ...
                        a = a.replace(ha, "|").split("|");
                        for (Ka = 0; Ka < a.length; Ka++) a[Ka] = f(a[Ka]);
                        return a.join(",")
                    }
                    if (b = (a.match(v) || [e])[0], Xa = a.split(b).join("").match(T) || [], Ka = Xa.length, h > Ka--)
                        for (; ++Ka < h;) Xa[Ka] = c ? Xa[(Ka - 1) / 2 | 0] : g[Ka];
                    return t + Xa.join(r) + r + b + k + (-1 !== a.indexOf("inset") ? " inset" : "")
                } : function(a) {
                    var b, e;
                    if ("number" == typeof a) a += l;
                    else if (d && ha.test(a)) {
            ...
            Sa = function(a) {
                return a = a.split(","),
                    function(b, c, d, f, e, g, t) {
                        d = (c + "").split(" ");
                        t = {};
                        for (c = 0; 4 > c; c++) t[a[c]] = d[c] = d[c] || d[(c - 1) / 2 >> 0];
                        return f.parse(b, t, e, g)
                    }
            },
            ja = (ka._setPluginRatio = function(a) {
                this.plugin.setRatio(a);
                var b, c, d;
                d = this.data;
                for (var f = d.proxy, e = d.firstMPT; e;) b = f[e.v], e.r ? b = e.r(b) : 1E-6 > b && -1E-6 < b && (b = 0), e.t[e.p] =
                    b, e = e._next;
            ...
            ya = (ka._parseToProxy = function(a, b, c, d, f, e) {
                ...
                d = a = c.parse(a, b, d, f);
                ma = w;
                for (e && (c._transform = t, r && (r._prev = null, r._prev && (r._prev._next = null))); d && d !== r;) {
                    if (1 >= d.type && (g = d.p, l[g] = d.s + d.c, h[g] = d.s, e || (k = new ja(d, "s", g, k, d.r), d.c = 0), 1 === d.type))
                        for (c = d.l; 0 < --c;) t = "xn" + c, g = d.p + "_" + t, l[g] = d.data[t], h[g] = d[t], e || (k = new ja(d, t, g, k, d.rxp[t]));
                    d = d._next
                }
                return {
                    proxy: h,
            ...
            }, ka.CSSPropTween = function(b, c, d, f, g, t, k, r, h, l, w) {
                this.t = b;
                this.p = c;
                this.s = d;
                this.c = f;
                ...
                this.r = r ? "function" ==
                    typeof r ? r : Math.round : r;
                this.type = t || 0;
                h && (this.pr = h, a = !0);
                this.b = void 0 === l ? d : l;
                this.e = void 0 === w ? d + f : w;
            ...
            gb = g.parseComplex = function(a, b, c, d, f, e, t, k, h, l) {
                c = c || e || "";
                "function" == typeof d && (d = d(q, r));
                t = new ya(a, b, 0, 0, t, l ? 2 : 1, null, !1, k, c, d);
                d += "";
                f && v.test(d + c) && (d = [c, d], g.colorStringFilter(d), c = d[0], d = d[1]);
                var w, u, A, m, U;
                a = c.split(", ").join(",").split(" ");
                b = d.split(", ").join(",").split(" ");
                k = a.length;
                var M = !1 !== n;
                (-1 !== d.indexOf(",") || -1 !== c.indexOf(",")) && (-1 !== (d + c).indexOf("rgb") || -1 !== (d + c).indexOf("hsl") ? (a = a.join(" ").replace(ha, ", ").split(" "), b = b.join(" ").replace(ha, ", ").split(" ")) : (a = a.join(" ").split(",").join(", ").split(" "), b = b.join(" ").split(",").join(", ").split(" ")), k = a.length);
                k !== b.length && (a = (e || "").split(" "), k = a.length);
                t.plugin = h;
                t.setRatio = l;
                for (c = v.lastIndex = 0; k > c; c++)
                    if (u = a[c], h = b[c] + "", m = parseFloat(u), m || 0 === m) t.appendXtra("", m, S(h, m), h.replace(X, ""),
                        M && -1 !== h.indexOf("px") ? Math.round : !1, !0);
                    else if (f && v.test(u)) w = h.indexOf(")") + 1, w = ")" + (w ? h.substr(w) : ""), U = -1 !== h.indexOf("hsl") && E, e = h, u = Ba(u, U), h = Ba(h, U), (l = 6 < u.length + h.length) && !E && 0 === h[3] ? (t["xs" + t.l] += t.l ? " transparent" : "transparent", t.e = t.e.split(b[c]).join("transparent")) : (E || (l = !1), U ? t.appendXtra(e.substr(0, e.indexOf("hsl")) + (l ? "hsla(" : "hsl("), u[0], S(h[0], u[0]), ",", !1, !0).appendXtra("", u[1], S(h[1], u[1]), "%,", !1).appendXtra("", u[2], S(h[2], u[2]), l ? "%," : "%" + w, !1) : t.appendXtra(e.substr(0,
                    e.indexOf("rgb")) + (l ? "rgba(" : "rgb("), u[0], h[0] - u[0], ",", Math.round, !0).appendXtra("", u[1], h[1] - u[1], ",", Math.round).appendXtra("", u[2], h[2] - u[2], l ? "," : w, Math.round), l && (u = 4 > u.length ? 1 : u[3], t.appendXtra("", u, (4 > h.length ? 1 : h[3]) - u, w, !1))), v.lastIndex = 0;
                else if (l = u.match(y)) {
                    if (A = h.match(X), !A || A.length !== l.length) return t;
                    for (h = w = 0; h < l.length; h++) U = l[h], e = u.indexOf(U, w), t.appendXtra(u.substr(w, e - w), Number(U), S(A[h], U), "", M && "px" === u.substr(e + U.length, 2) ? Math.round : !1, 0 === h), w = e + U.length;
                    t["xs" + t.l] +=
                        u.substr(w)
                } else t["xs" + t.l] += t.l || t["xs" + t.l] ? " " + h : h;
                if (-1 !== d.indexOf("=") && t.data) {
                    w = t.xs0 + t.data.s;
                    for (c = 1; c < t.l; c++) w += t["xs" + c] + t.data["xn" + c];
                    t.e = w + t["xs" + c]
                }
            ...
            za = 9,
            h = ya.prototype;
        for (h.l = h.pr = 0; 0 < --za;) h["xn" + za] = 0, h["xs" + za] = "";
        h.xs0 = "";
        h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null;
        h.appendXtra = function(a, b, c, d, f, e) {
            var g = this.l;
            return this["xs" + g] += e && (g || this["xs" + g]) ? " " + a : a || "", c || 0 === g || this.plugin ? (this.l++, this.type = this.setRatio ?
                2 : 1, this["xs" + this.l] = d || "", 0 < g ? (this.data["xn" + g] = b + c, this.rxp["xn" + g] = f, this["xn" + g] = b, this.plugin || (this.xfirst = new ya(this, "xn" + g, b, c, this.xfirst || this, 0, this.n, f, this.pr), this.xfirst.xs0 = 0), this) : (this.data = {
                    s: b + c
        ...
        var Da = function(a, b) {
            ...
            xb = ka._registerPluginProp = function(a) {
                if (!l[a]) {
                    ...
                    ra(a, {
                        parser: function(a, c, d, f, e, g, t) {
                            var h = k.com.greensock.plugins[b];
                            h ? a = (h._cssRegister(), l[d].parse(a,
                                c, d, f, e, g, t)) : (_gsScope.console && console.log("Error: " + b + " js file not loaded."), a = e);
                            return a
                        }
                    })
                }
            ...
            h = Da.prototype;
        h.parseComplex = function(a, b, c, d, f, e) {
            var g, t, k, h, r, l, u = this.keyword;
            if (this.multi && (ha.test(c) || ha.test(b) ? (t = b.replace(ha, "|").split("|"), k = c.replace(ha, "|").split("|")) : u && (t = [b], k = [c])), k) {
                h = k.length > t.length ? k.length : t.length;
                for (g = 0; h > g; g++) b = t[g] = t[g] || this.dflt, c = k[g] = k[g] || this.dflt, u && (r = b.indexOf(u), l = c.indexOf(u), r !== l && (-1 === l ? t[g] = t[g].split(u).join("") : -1 === r && (t[g] += " " +
                    u)));
                b = t.join(", ");
                c = k.join(", ")
            }
        ...
        var Va, Ha = "scaleX scaleY scaleZ x y z skewX skewY rotation rotationX rotationY perspective xPercent yPercent".split(" "),
            ...
            jb = function(a, b, c) {
                var d;
                a = ca.createElementNS("http://www.w3.org/2000/svg", a);
                var f = /([a-z])([A-Z])/g;
            ...
            function() {
                ...
                return ca.createElementNS && !d && (a = jb("svg", bb), b = jb("rect", a, {
                    ...
                    height: 50,
                    x: 100
                }), c = b.getBoundingClientRect().width, b.style[Ma] = "50% 50%", b.style[wa] = "scaleX(0.5)", d = c === b.getBoundingClientRect().width && !(B && Aa), bb.removeChild(a)), d
            }(),
            db = function(a, b, c, d, f, e) {
                var t, k, h, r, l, u, w, v, A, m, q, U, n, M = a._gsTransform,
                    R = Na(a, !0);
                M && (U = M.xOrigin, n = M.yOrigin);
                (!d || 2 > (t = d.split(" ")).length) && (u = a.getBBox(), 0 === u.x && 0 === u.y && 0 === u.width + u.height &&
                    (u = {
                        x: parseFloat(a.hasAttribute("x") ? a.getAttribute("x") : a.hasAttribute("cx") ? a.getAttribute("cx") : 0) || 0,
                        y: parseFloat(a.hasAttribute("y") ? a.getAttribute("y") : a.hasAttribute("cy") ? a.getAttribute("cy") : 0) || 0,
                        width: 0,
                        height: 0
                    }), b = N(b).split(" "), t = [(-1 !== b[0].indexOf("%") ? parseFloat(b[0]) / 100 * u.width : parseFloat(b[0])) + u.x, (-1 !== b[1].indexOf("%") ? parseFloat(b[1]) / 100 * u.height : parseFloat(b[1])) + u.y]);
                c.xOrigin = b = parseFloat(t[0]);
                c.yOrigin = r = parseFloat(t[1]);
                d && R !== kb && (l = R[0], u = R[1], w = R[2], v = R[3], A = R[4],
                    m = R[5], q = l * v - u * w, q && (k = v / q * b + -w / q * r + (w * m - v * A) / q, h = -u / q * b + l / q * r - (l * m - u * A) / q, b = c.xOrigin = t[0] = k, r = c.yOrigin = t[1] = h));
                M && (e && (c.xOffset = M.xOffset, c.yOffset = M.yOffset, M = c), f || !1 !== f && !1 !== g.defaultSmoothOrigin ? (k = b - U, h = r - n, M.xOffset += k * R[0] + h * R[2] - k, M.yOffset += k * R[1] + h * R[3] - h) : M.xOffset = M.yOffset = 0);
                e || a.setAttribute("data-svg-origin", t.join(" "))
            },
            ob = function(a) {
                var b, c = ia("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
                    d = this.parentNode,
                    f = this.nextSibling,
            ...
            Na = function(a, b) {
                var c,
                    d, f, e, g, t, k = a._gsTransform || new hb,
                    h = a.style;
                if (wa ? d = ba(a, mb, null, !0) : a.currentStyle && (d = a.currentStyle.filter.match(Z), d = d && 4 === d.length ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), k.x || 0, k.y || 0].join() : ""), c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d, !wa || !(t = !oa(a) || "none" === oa(a).display) && a.parentNode || (t && (e = h.display, h.display = "block"), a.parentNode || (g = 1, bb.appendChild(a)), d = ba(a, mb, null, !0), c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d, e ? h.display = e :
                        t && Ea(h, "display"), g && bb.removeChild(a)), (k.svg || a.getCTM && pb(a)) && (c && -1 !== (h[wa] + "").indexOf("matrix") && (d = h[wa], c = 0), f = a.getAttribute("transform"), c && f && (f = a.transform.baseVal.consolidate().matrix, d = "matrix(" + f.a + "," + f.b + "," + f.c + "," + f.d + "," + f.e + "," + f.f + ")", c = 0)), c) return kb;
                f = (d || "").match(y) || [];
                for (za = f.length; - 1 < --za;) e = Number(f[za]), f[za] = (g = e - (e |= 0)) ? (1E5 * g + (0 > g ? -.5 : .5) | 0) / 1E5 + e : e;
                return b && 6 < f.length ? [f[0], f[1], f[4], f[5], f[12], f[13]] : f
            },
            Ja = ka.getTransform = function(a, b, d, f) {
                if (a._gsTransform &&
                    d && !f) return a._gsTransform;
                var e, t, k, h = d ? a._gsTransform || new hb : new hb,
                    r = 0 > h.scaleX,
                    l = Aa ? parseFloat(ba(a, Ma, b, !1, "0 0 0").split(" ")[2]) || h.zOrigin || 0 : 0,
                    u = parseFloat(g.defaultTransformPerspective) || 0;
                if (h.svg = !(!a.getCTM || !pb(a)), h.svg && (db(a, ba(a, Ma, b, !1, "50% 50%") + "", h, a.getAttribute("data-svg-origin")), Va = g.useSVGTransformAttr || sb), e = Na(a), e !== kb) {
                    if (16 === e.length) {
                        var w, v, A, m, u = e[0];
                        b = e[1];
                        f = e[2];
                        var q = e[3],
                            ...
                            da =
                            Math.atan2(M, y);
                        h.zOrigin && (x = -h.zOrigin, O = N * x - e[12], ja = S * x - e[13], x = y * x + h.zOrigin - e[14]);
                        h.rotationX = da * la;
                        da && (m = Math.cos(-da), k = Math.sin(-da), w = U * m + N * k, v = n * m + S * k, A = M * m + y * k, N = U * -k + N * m, S = n * -k + S * m, y = M * -k + y * m, p = R * -k + p * m, U = w, n = v, M = A);
                        da = Math.atan2(-f, y);
                        h.rotationY = da * la;
                        da && (m = Math.cos(-da), k = Math.sin(-da), w = u * m - N * k, v = b * m - S * k, A = f * m - y * k, S = b * k + S * m, y = f * k + y * m, p = q * k + p * m, u = w, b = v, f = A);
                        da = Math.atan2(b, u);
                        h.rotation = da * la;
                        da && (m = Math.cos(da), k = Math.sin(da), w = u * m + b * k, v = U * m + n * k, A = N * m + S * k, b = b * m - u * k, n = n * m - U * k, S =
                            S * m - N * k, u = w, U = v, N = A);
                        h.rotationX && 359.9 < Math.abs(h.rotationX) + Math.abs(h.rotation) && (h.rotationX = h.rotation = 0, h.rotationY = 180 - h.rotationY);
                        da = Math.atan2(U, n);
                        h.scaleX = (1E5 * Math.sqrt(u * u + b * b + f * f) + .5 | 0) / 1E5;
                        h.scaleY = (1E5 * Math.sqrt(n * n + M * M) + .5 | 0) / 1E5;
                        h.scaleZ = (1E5 * Math.sqrt(N * N + S * S + y * y) + .5 | 0) / 1E5;
                        u /= h.scaleX;
                        U /= h.scaleY;
                        b /= h.scaleX;
                        n /= h.scaleY;
                        2E-5 < Math.abs(da) ? (h.skewX = da * la, U = 0, "simple" !== h.skewType && (h.scaleY *= 1 / Math.cos(da))) : h.skewX = 0;
                        h.perspective = p ? 1 / (0 > p ? -p : p) : 0;
                        h.x = O;
                        h.y = ja;
                        h.z = x;
                        h.svg && (h.x -=
                            h.xOrigin - (h.xOrigin * u - h.yOrigin * U), h.y -= h.yOrigin - (h.yOrigin * b - h.xOrigin * n))
                    } else Aa && !f && e.length && h.x === e[4] && h.y === e[5] && (h.rotationX || h.rotationY) || (w = (m = 6 <= e.length) ? e[0] : 1, v = e[1] || 0, A = e[2] || 0, m = m ? e[3] : 1, h.x = e[4] || 0, h.y = e[5] || 0, e = Math.sqrt(w * w + v * v), k = Math.sqrt(m * m + A * A), b = w || v ? Math.atan2(v, w) * la : h.rotation || 0, f = A || m ? Math.atan2(A, m) * la + b : h.skewX || 0, h.scaleX = e, h.scaleY = k, h.rotation = b, h.skewX = f, Aa && (h.rotationX = h.rotationY = h.z = 0, h.perspective = u, h.scaleZ = 1), h.svg && (h.x -= h.xOrigin - (h.xOrigin * w + h.yOrigin *
                        A), h.y -= h.yOrigin - (h.xOrigin * v + h.yOrigin * m)));
                    90 < Math.abs(h.skewX) && 270 > Math.abs(h.skewX) && (r ? (h.scaleX *= -1, h.skewX += 0 >= h.rotation ? 180 : -180, h.rotation += 0 >= h.rotation ? 180 : -180) : (h.scaleY *= -1, h.skewX += 0 >= h.skewX ? 180 : -180));
                    h.zOrigin = l;
                    for (t in h) 2E-5 > h[t] && -2E-5 < h[t] && (h[t] = 0)
                }
                return d && (a._gsTransform = h, h.svg && (Va && a.style[wa] ? c.delayedCall(.001, function() {
                    Ea(a.style, wa)
            ...
            eb = function(a) {
                var b, c, d =
                    ...
                    r = (Math.cos(e) * d.scaleY * 1E5 | 0) / 1E5,
                    e = this.t.style;
                if (f = this.t.currentStyle) {
                    ...
                    var w = this.t.offsetHeight,
                        ...
                        A = "progid:DXImageTransform.Microsoft.Matrix(M11=" + g + ", M12=" + h + ", M21=" + k + ", M22=" + r,
                        U = d.x + c * d.xPercent / 100,
                        q = d.y + w * d.yPercent / 100;
                    if (null != d.ox && (l = (d.oxp ? c * d.ox *
                            .01 : d.ox) - c / 2, u = (d.oyp ? w * d.oy * .01 : d.oy) - w / 2, U += l - (l * g + u * h), q += u - (l * k + u * r)), v ? (l = c / 2, u = w / 2, A += ", Dx=" + (l - (l * g + u * h) + U) + ", Dy=" + (u - (l * k + u * r) + q) + ")") : A += ", sizingMethod='auto expand')", -1 !== b.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.filter = b.replace(na, A) : e.filter = A + " " + b, (0 === a || 1 === a) && 1 === g && 0 === h && 0 === k && 1 === r && (v && -1 === A.indexOf("Dx=0, Dy=0") || F.test(b) && 100 !== parseFloat(RegExp.$1) || -1 === b.indexOf(b.indexOf("Alpha")) && e.removeAttribute("filter")), !v)
                        for (a = 8 > m ? 1 : -1, l = d.ieOffsetX || 0, u = d.ieOffsetY ||
                            0, d.ieOffsetX = Math.round((c - ((0 > g ? -g : g) * c + (0 > h ? -h : h) * w)) / 2 + U), d.ieOffsetY = Math.round((w - ((0 > r ? -r : r) * w + (0 > k ? -k : k) * c)) / 2 + q), za = 0; 4 > za; za++) g = R[za], h = f[g], c = -1 !== h.indexOf("px") ? parseFloat(h) : t(this.t, g, parseFloat(h), h.replace(I, "")) || 0, h = c !== d[g] ? 2 > za ? -d.ieOffsetX : -d.ieOffsetY : 2 > za ? l - d.ieOffsetX : u - d.ieOffsetY, e[g] = (d[g] = Math.round(c - h * (0 === za || 2 === za ? 1 : a))) + "px"
                }
            },
            qb = ka.set3DTransformRatio = ka.setTransformRatio = function(a) {
                var b, c, d, f, e, g, t, h, k, r, l, u, w, v, A, m, U, q = this.data,
                    n = this.t.style,
                    M = q.rotation,
                    N = q.rotationX,
                    R = q.rotationY,
                ...
                if (h && (k += h, M += h), !((1 !== a && 0 !== a || "auto" !== t || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && t || Oa || Wa || R || N) && 1 === O || Va && lb || !Aa) return void(M || k || lb ? (M *= x, g = k * x, c = Math.cos(M) * S, f = Math.sin(M) * S, d = Math.sin(M - g) * -y, e = Math.cos(M - g) * y, g && "simple" === q.skewType && (b = Math.tan(g - h * x), b = Math.sqrt(1 + b * b), d *= b, e *= b, h && (b = Math.tan(h * x), b = Math.sqrt(1 +
                    ...
                    w) : n[wa] = (q.xPercent || q.yPercent ? "translate(" + q.xPercent + "%," + q.yPercent + "%) matrix(" : "matrix(") + S + ",0,0," + y + "," + p + "," + da + ")");
                if (B && (v = 1E-4, v > S && S > -v && (S = O = 2E-5), v > y && y > -v && (y = O = 2E-5), !Wa || q.z || q.rotationX || q.rotationY || (Wa = 0)), M || k) M *= x, A = c = Math.cos(M), m = f = Math.sin(M), k && (M -= k * x, A = Math.cos(M), m = Math.sin(M), "simple" === q.skewType && (b = Math.tan((k - h) * x), b = Math.sqrt(1 + b * b), A *= b, m *= b, q.skewY && (b = Math.tan(h * x), b = Math.sqrt(1 + b * b), c *= b, f *= b))), d = -m, e = A;
                else {
                    if (!(R || N || 1 !== O || Wa || lb)) return void(n[wa] = (q.xPercent ||
                        q.yPercent ? "translate(" + q.xPercent + "%," + q.yPercent + "%) translate3d(" : "translate3d(") + p + "px," + da + "px," + Oa + "px)" + (1 !== S || 1 !== y ? " scale(" + S + "," + y + ")" : ""));
                    c = e = 1;
                    d = f = 0
                }
                k = 1;
                ...
                w = q.zOrigin;
                v = 1E-6;
                (M = R * x) && (A = Math.cos(M), m = Math.sin(M), t = -m, r = u * -m, a = c * m, g = f * m, k = A, u *= A, c *= A, f *= A);
                (M = N * x) && (A = Math.cos(M), m = Math.sin(M), b = d * A + a * m, U = e * A + g * m, h = k * m, l = u * m, a = d * -m + a * A, g = e * -m + g * A, k *= A, u *= A, d = b, e = U);
                1 !== O && (a *= O, g *= O, k *= O, u *= O);
                1 !== y && (d *= y, e *= y, h *= y, l *= y);
                1 !== S && (c *= S, f *= S, t *= S, r *= S);
                (w || lb) &&
                (w && (p += a * -w, da += g * -w, Oa += k * -w + w), lb && (p += q.xOrigin - (q.xOrigin * c + q.yOrigin * d) + q.xOffset, da += q.yOrigin - (q.xOrigin * f + q.yOrigin * e) + q.yOffset), v > p && p > -v && (p = "0"), v > da && da > -v && (da = "0"), v > Oa && Oa > -v && (Oa = 0));
                w = q.xPercent || q.yPercent ? "translate(" + q.xPercent + "%," + q.yPercent + "%) matrix3d(" : "matrix3d(";
                w = w + ((v > c && c > -v ? "0" : c) + "," + (v > f && f > -v ? "0" : f) + "," + (v > t && t > -v ? "0" : t)) + ("," + (v > r && r > -v ? "0" : r) + "," + (v > d && d > -v ? "0" : d) + "," + (v > e && e > -v ? "0" : e));
                N || R || 1 !== O ? (w += "," + (v > h && h > -v ? "0" : h) + "," + (v > l && l > -v ? "0" : l) + "," + (v > a && a >
                    -v ? "0" : a), w += "," + (v > g && g > -v ? "0" : g) + "," + (v > k && k > -v ? "0" : k) + "," + (v > u && u > -v ? "0" : u) + ",") : w += ",0,0,0,0,1,0,";
                n[wa] = w + (p + "," + da + "," + Oa + "," + (Wa ? 1 + -Oa / Wa : 1) + ")")
            },
            h = hb.prototype;
        ...
        ra("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(a, b, c, d, e, t, h) {
                ...
                var S = a.style,
                    R = Ha.length,
                    y = {},
                    p = Ja(a, f, !0, h.parseTransform),
                    ja = h.transform && ("function" == typeof h.transform ? h.transform(q, r) : h.transform);
                if (p.skewType = h.skewType || p.skewType || g.defaultSkewType, d._transform = p, ja && "string" == typeof ja && wa) w = qa.style, w[wa] =
                    ja, w.display = "block", w.position = "absolute", -1 !== ja.indexOf("%") && (w.width = ba(a, "width"), w.height = ba(a, "height")), ca.body.appendChild(qa), u = Ja(qa, null, !1), "simple" === p.skewType && (u.scaleY *= Math.cos(u.skewX * x)), p.svg && (m = p.xOrigin, U = p.yOrigin, u.x -= p.xOffset, u.y -= p.yOffset, (h.transformOrigin || h.svgOrigin) && (ja = {}, db(a, N(h.transformOrigin), ja, h.svgOrigin, h.smoothOrigin, !0), m = ja.xOrigin, U = ja.yOrigin, u.x -= ja.xOffset - p.xOffset, u.y -= ja.yOffset - p.yOffset), (m || U) && (M = Na(qa, !0), u.x -= m - (m * M[0] + U * M[2]), u.y -= U -
                        (m * M[1] + U * M[3]))), ca.body.removeChild(qa), u.perspective || (u.perspective = p.perspective), null != h.xPercent && (u.xPercent = O(h.xPercent, p.xPercent)), null != h.yPercent && (u.yPercent = O(h.yPercent, p.yPercent));
                else if ("object" == typeof h) {
                    if (u = {
                            scaleX: O(null != h.scaleX ? h.scaleX : h.scale, p.scaleX),
                            scaleY: O(null != h.scaleY ? h.scaleY : h.scale, p.scaleY),
                            scaleZ: O(h.scaleZ, p.scaleZ),
                            x: O(h.x, p.x),
                            y: O(h.y, p.y),
                            z: O(h.z, p.z),
                            xPercent: O(h.xPercent, p.xPercent),
                            yPercent: O(h.yPercent, p.yPercent),
                            perspective: O(h.transformPerspective,
                                p.perspective)
                        }, v = h.directionalRotation, null != v)
                        if ("object" == typeof v)
                            for (w in v) h[w] = v[w];
                        else h.rotation = v;
                    "string" == typeof h.x && -1 !== h.x.indexOf("%") && (u.x = 0, u.xPercent = O(h.x, p.xPercent));
                    "string" == typeof h.y && -1 !== h.y.indexOf("%") && (u.y = 0, u.yPercent = O(h.y, p.yPercent));
                    u.rotation = Ga("rotation" in h ? h.rotation : "shortRotation" in h ? h.shortRotation + "_short" : "rotationZ" in h ? h.rotationZ : p.rotation, p.rotation, "rotation", y);
                    Aa && (u.rotationX = Ga("rotationX" in h ? h.rotationX : "shortRotationX" in h ? h.shortRotationX +
                        "_short" : p.rotationX || 0, p.rotationX, "rotationX", y), u.rotationY = Ga("rotationY" in h ? h.rotationY : "shortRotationY" in h ? h.shortRotationY + "_short" : p.rotationY || 0, p.rotationY, "rotationY", y));
                    u.skewX = Ga(h.skewX, p.skewX);
                    u.skewY = Ga(h.skewY, p.skewY)
                }
                Aa && null != h.force3D && (p.force3D = h.force3D, A = !0);
                for ((v = p.force3D || p.z || p.rotationX || p.rotationY || u.z || u.rotationX || u.rotationY || u.perspective) || null == h.scale || (u.scaleZ = 1); - 1 < --R;) n = Ha[R], ja = u[n] - p[n], (1E-6 < ja || -1E-6 > ja || null != h[n] || null != ma[n]) && (A = !0, e = new ya(p,
                    n, p[n], ja, e), n in y && (e.e = y[n]), e.xs0 = 0, e.plugin = t, d._overwriteProps.push(e.n));
                return ja = h.transformOrigin, p.svg && (ja || h.svgOrigin) && (m = p.xOffset, U = p.yOffset, db(a, N(ja), u, h.svgOrigin, h.smoothOrigin), e = Ua(p, "xOrigin", (b ? p : u).xOrigin, u.xOrigin, e, "transformOrigin"), e = Ua(p, "yOrigin", (b ? p : u).yOrigin, u.yOrigin, e, "transformOrigin"), (m !== p.xOffset || U !== p.yOffset) && (e = Ua(p, "xOffset", b ? m : p.xOffset, p.xOffset, e, "transformOrigin"), e = Ua(p, "yOffset", b ? U : p.yOffset, p.yOffset, e, "transformOrigin")), ja = "0px 0px"), (ja ||
        ...
        ra("borderRadius", {
            ...
            parser: function(a, b, c, e, g, h) {
                b = this.format(b);
                var k, u, r, l, w, v, A, m, q, U, n, M, p, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                    R = a.style;
                e = parseFloat(a.offsetWidth);
                h = parseFloat(a.offsetHeight);
                b = b.split(" ");
                for (k = 0; k < S.length; k++) this.p.indexOf("border") && (S[k] = xa(S[k])), l = r = ba(a, S[k], f, !1, "0px"), -1 !== l.indexOf(" ") && (r = l.split(" "), l = r[0], r = r[1]), w = u = b[k], v = parseFloat(l),
        ...
        ra("backgroundPosition", {
            ...
            parser: function(a, b, c, d, e, g) {
                ...
                var u = this.format(b);
                if (-1 !== c.indexOf("%") != (-1 !== u.indexOf("%")) && 2 > u.split(",").length && (t = ba(a, "backgroundImage").replace(W, ""), t && "none" !== t)) {
                    b = c.split(" ");
                    d = u.split(" ");
                    pa.setAttribute("src", t);
                    for (t = 2; - 1 < --t;) c = b[t], h = -1 !== c.indexOf("%"), h !== (-1 !== d[t].indexOf("%")) && (k = 0 === t ? a.offsetWidth - pa.width : a.offsetHeight - pa.height, b[t] = h ? parseFloat(c) / 100 * k + "px" : parseFloat(c) / k * 100 + "%");
                    c = b.join(" ")
                }
        ...
        ra("backgroundSize", {
            ...
            formatter: function(a) {
                return a += "", "co" === a.substr(0, 2) ? a : N(-1 === a.indexOf(" ") ? a + " " + a : a)
            }
        });
        ra("perspective", {
            defaultValue: "0px",
        ...
        ra("clip", {
            ...
            parser: function(a, b, c, d, e, g) {
                var t, h, k;
                return 9 > m ? (h = a.currentStyle, k = 8 > m ? " " : ",", t = "rect(" + h.clipTop + k + h.clipRight + k + h.clipBottom + k + h.clipLeft + ")", b = this.format(b).split(",").join(k)) : (t = this.format(ba(a, this.p, f, !1, this.dflt)), b = this.format(b)), this.parseComplex(a.style, t, b, e, g)
            }
        });
        ra("textShadow", {
        ...
        ra("border", {
            ...
            parser: function(a, b, c, d, e, g) {
                ...
                d = b[0].replace(I, "");
                return "px" !== d && (c = parseFloat(c) / t(a, "borderTopWidth", 1, d) + d), this.parseComplex(a.style, this.format(c + " " + ba(a, "borderTopStyle", f, !1, "solid") + " " + ba(a, "borderTopColor", f, !1, "#000")), b.join(" "), e, g)
            },
            color: !0,
            formatter: function(a) {
                var b = a.split(" ");
                return b[0] + " " + (b[1] || "solid") + " " + (a.match(v) || ["#000"])[0]
            }
        });
        ra("borderWidth", {
        ...
        var Qa = function(a) {
            ...
            a = this.s + this.c * a | 0;
            100 === a && (-1 === d.indexOf("atrix(") && -1 === d.indexOf("radient(") && -1 === d.indexOf("oader(") ? (c.removeAttribute("filter"), b = !ba(this.data, "filter")) : (c.filter = d.replace(K, ""), b = !0));
            b || (this.xn1 && (c.filter = d = d || "alpha(opacity=" + a + ")"), -1 === d.indexOf("pacity") ?
                0 === a && this.xn1 || (c.filter = d + " alpha(opacity=" + a + ")") : c.filter = d.replace(F, "opacity=" + a))
        };
        ra("opacity,alpha,autoAlpha", {
            defaultValue: "1",
            parser: function(a, b, c, d, e, g) {
                var t = parseFloat(ba(a, "opacity", f, !1, "1")),
                    h = a.style,
                    k = "autoAlpha" === c;
                return "string" == typeof b && "=" === b.charAt(1) && (b = ("-" === b.charAt(0) ? -1 : 1) * parseFloat(b.substr(2)) + t), k && 1 === t && "hidden" === ba(a, "visibility", f) && 0 !== b && (t = 0), E ? e = new ya(h, "opacity", t, b - t, e) : (e = new ya(h, "opacity", 100 * t, 100 * (b - t), e), e.xn1 = k ? 1 : 0, h.zoom = 1, e.type = 2, e.b =
                    "alpha(opacity=" + e.s + ")", e.e = "alpha(opacity=" + (e.s + e.c) + ")", e.data = a, e.plugin = g, e.setRatio = Qa), k && (e = new ya(h, "visibility", 0, 0, e, -1, null, !1, 0, 0 !== t ? "inherit" : "hidden", 0 === b ? "hidden" : "inherit"), e.xs0 = "inherit", d._overwriteProps.push(e.n), d._overwriteProps.push(c)), e
            }
        });
        var Ea = function(a, b) {
                b && (a.removeProperty ? (("ms" === b.substr(0, 2) || "webkit" === b.substr(0, 6)) && (b = "-" + b), a.removeProperty(b.replace(Q, "-$1").toLowerCase())) : a.removeAttribute(b))
            },
            ib = function(a) {
        ...
        ra("className", {
            parser: function(b, c, d, e, g, t, h) {
                var k, r, l, w, v = b.getAttribute("class") || "",
                    m = b.style.cssText;
                if (g = e._classNamePT = new ya(b, d, 0, 0, g, 2), g.setRatio = ib, g.pr = -11, a = !0, g.b = v, d = u(b, f), r = b._gsClassPT) {
                    l = {};
                    for (w = r.data; w;) l[w.p] = 1, w = w._next;
                    r.setRatio(1)
                }
                return b._gsClassPT =
                    g, g.e = "=" !== c.charAt(1) ? c : v.replace(new RegExp("(?:\\s|^)" + c.substr(2) + "(?![\\w-])"), "") + ("+" === c.charAt(0) ? " " + c.substr(2) : ""), b.setAttribute("class", g.e), k = A(b, d, u(b), h, l), b.setAttribute("class", v), g.data = k.firstMPT, b.style.cssText = m, g.xfirst = e.parse(b, k.difs, g, t)
            }
        });
        var zb = function(a) {
            if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e) f.cssText = "", d = !0;
                    ...
                    for (a = this.e.split(" ").join("").split(","),
                        c = a.length; - 1 < --c;) b = a[c], l[b] && (l[b].parse === g ? d = !0 : b = "transformOrigin" === b ? Ma : l[b].p), Ea(f, b);
        ...
        for (za = h.length; za--;) xb(h[za]);
        h = g.prototype;
        h._firstPT = h._lastParsedTransform =
            h._transform = null;
        h._onInitTween = function(b, c, t, h) {
            ...
            var k, w, v, m, U;
            h = b.style;
            if (p && "" === h.zIndex && (k = ba(b, "zIndex", f), ("auto" === k || "" === k) && this._addLazySet(h, "zIndex", 0)), "string" == typeof c && (m = h.cssText, k = u(b, f), h.cssText = m + ";" + c, k = A(b, k, u(b)).difs, !E && C.test(c) && (k.opacity = parseFloat(RegExp.$1)), c = k, h.cssText = m), c.className ? this._firstPT = w = l.className.parse(b,
                    c.className, "className", this, null, null, c) : this._firstPT = w = this.parse(b, c, null), this._transformType) {
                c = 3 === this._transformType;
                wa ? z && (p = !0, "" === h.zIndex && (v = ba(b, "zIndex", f), ("auto" === v || "" === v) && this._addLazySet(h, "zIndex", 0)), V && this._addLazySet(h, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (c ? "visible" : "hidden"))) : h.zoom = 1;
                for (v = w; v && v._next;) v = v._next;
                c = new ya(b, "transform", 0, 0, null, 2);
                this._linkCSSP(c, null, v);
                c.setRatio = wa ? qb : eb;
            ...
            if (a) {
                for (; w;) {
                    b = w._next;
                    for (v = m; v && v.pr > w.pr;) v = v._next;
                    (w._prev = v ? v._prev : U) ? w._prev._next = w: m = w;
                    (w._next = v) ? v._prev = w: U = w;
                    w = b
                }
                this._firstPT = m
            }
        ...
        h.parse = function(a, b, c, e) {
            var g, h, k, u, v, m, A, U, p, S = a.style;
            for (g in b) {
                if (v = b[g], "function" == typeof v && (v = v(q, r)), h = l[g]) c = h.parse(a, v, g, this, c, e, b);
                else {
                    if ("--" === g.substr(0, 2)) {
                        this._tween._propLookup[g] = this._addTween.call(this._tween, a.style, "setProperty", oa(a).getPropertyValue(g) + "", v + "", g, !1, g);
                        continue
                    }
                    h = ba(a, g, f) + "";
                    U = "string" ==
                        typeof v;
                    if ("color" === g || "fill" === g || "stroke" === g || -1 !== g.indexOf("Color") || U && G.test(v)) U || (v = Ba(v), v = (3 < v.length ? "rgba(" : "rgb(") + v.join(",") + ")"), c = gb(S, g, h, v, !0, "transparent", c, 0, e);
                    else if (U && H.test(v)) c = gb(S, g, h, v, !0, null, c, 0, e);
                    else {
                        m = (k = parseFloat(h)) || 0 === k ? h.substr((k + "").length) : "";
                        if ("" === h || "auto" === h)
                            if ("width" === g || "height" === g) {
                                k = a;
                                var R = g;
                                m = f;
                                if ("svg" === (k.nodeName + "").toLowerCase()) k = (m || oa(k))[R] || 0;
                                else if (k.getCTM && pb(k)) k = k.getBBox()[R] || 0;
                                else {
                                    p = parseFloat("width" === R ? k.offsetWidth :
                                        k.offsetHeight);
                                    var R = M[R],
                                        N = R.length;
                                    for (m = m || oa(k, null); - 1 < --N;) p -= parseFloat(ba(k, "padding" + R[N], m, !0)) || 0, p -= parseFloat(ba(k, "border" + R[N] + "Width", m, !0)) || 0;
                                    k = p
                                }
                                m = "px"
                            } else "left" === g || "top" === g ? (k = w(a, g, f), m = "px") : (k = "opacity" !== g ? 0 : 1, m = "");
                        (p = U && "=" === v.charAt(1)) ? (u = parseInt(v.charAt(0) + "1", 10), v = v.substr(2), u *= parseFloat(v), A = v.replace(I, "")) : (u = parseFloat(v), A = U ? v.replace(I, "") : "");
                        "" === A && (A = g in d ? d[g] : m);
                        v = u || 0 === u ? (p ? u + k : u) + A : b[g];
                        m === A || "" === A && "lineHeight" !== g || !u && 0 !== u || !k || (k = t(a,
                            g, k, m), "%" === A ? (k /= t(a, g, 100, "%") / 100, !0 !== b.strictUnits && (h = k + "%")) : "em" === A || "rem" === A || "vw" === A || "vh" === A ? k /= t(a, g, 1, A) : "px" !== A && (u = t(a, g, u, A), A = "px"), !p || !u && 0 !== u || (v = u + k + A));
                        p && (u += k);
                        !k && 0 !== k || !u && 0 !== u ? void 0 !== S[g] && (v || "NaN" != v + "" && null != v) ? (c = new ya(S, g, u || k || 0, 0, c, -1, g, !1, 0, h, v), c.xs0 = "none" !== v || "display" !== g && -1 === g.indexOf("Style") ? v : h) : _gsScope.console && console.log("invalid " + g + " tween value: " + b[g]) : (c = new ya(S, g, k, u - k, c, 0, g, !1 !== n && ("px" === A || "zIndex" === g), 0, h, v), c.xs0 = A)
                    }
                }
                e &&
        ...
        h._enableTransforms = function(a) {
        ...
        h._addLazySet = function(a, b, c) {
            a = this._firstPT = new ya(a, b, 0, 0, this._firstPT, 2);
            a.e = c;
            a.setRatio = rb;
            a.data = this
        };
        h._linkCSSP = function(a, b, c, d) {
        ...
        var fb = function(a, b, c) {
            ...
            if (a.slice)
                ...
                for (a = a.childNodes, d = a.length; - 1 < --d;) e = a[d], f = e.type, e.style && (b.push(u(e)), c && c.push(e)), 1 !== f && 9 !== f && 11 !== f || !e.childNodes.length || fb(e, b, c)
        };
        return g.cascadeTo =
            function(a, b, d) {
                var e, f, g;
                ...
                g._enabled(!0);
                for (a = u.length; - 1 < --a;)
                    if (e = A(u[a], t[a], k[a]), e.firstMPT) {
                        e = e.difs;
                        for (f in d) v[f] && (e[f] = d[f]);
                        g = {};
                        for (f in e) g[f] = t[a][f];
                        h.push(c.fromTo(u[a], b, g, e))
                    }
                return h
            }, b.activate([g]), g
    }, !0);
            ...
            for (f in g)
                for (a = e._firstPT; a;) {
                    ...
                    if (a.pg) a.t._mod(g);
                        ...
                        if (2 === a.f && a.t) {
                            a = a.t._firstPT;
                            for (var l = g[f]; a;) a.f || a.blob || (a.m = l || Math.round), a =
                                a._next
    ...
    _gsScope._gsDefine.plugin({
        ...
        init: function(b, c, a, d) {
            ...
            for (f in c) "useRadians" !== f && (k = c[f], "function" == typeof k && (k = k(d, b)), h = (k + "").split("_"), e = h[0], g = parseFloat("function" != typeof b[f] ? b[f] : b[f.indexOf("set") || "function" != typeof b["get" + f.substr(3)] ? f : "get" + f.substr(3)]()),
                k = this.finals[f] = "string" == typeof e && "=" === e.charAt(1) ? g + parseInt(e.charAt(0) + "1", 10) * Number(e.substr(2)) : Number(e) || 0, l = k - g, h.length && (e = h.join("_"), -1 !== e.indexOf("short") && (l %= a, l !== l % (a / 2) && (l = 0 > l ? l + a : l - a)), -1 !== e.indexOf("_cw") && 0 > l ? l = (l + 9999999999 * a) % a - (l / a | 0) * a : -1 !== e.indexOf("ccw") && 0 < l && (l = (l - 9999999999 * a) % a - (l / a | 0) * a)), (1E-6 < l || -1E-6 > l) && (this._addTween(b, f, g, g + l, f), this._overwriteProps.push(f)));
            return !0
        },
        set: function(b) {
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(b) {
        var c, a, d, f, e = _gsScope.GreenSockGlobals || _gsScope,
            g = 2 * Math.PI,
            k = Math.PI / 2,
            l = e.com.greensock._class,
            h = function(a, c) {
                var d = l("easing." + a, function() {}, !0),
                    e = d.prototype = new b;
            ...
            V = l("easing.SlowMo", function(a, b, c) {
                null == a ? a = .7 : 1 < a && (a = 1);
        ...
        return m.constructor = V, m.getRatio = function(a) {
            ...
            m.config = V.config = function(a, b, c) {
                return new V(a, b, c)
            }, c = l("easing.SteppedEase", function(a, b) {
                a = a || 1;
                this._p1 = 1 / a;
                this._p2 = a + (b ? 0 : 1);
                this._p3 = b ? 1 : 0
                ...
                return new c(a, b)
            }, a = l("easing.ExpoScaleEase", function(a, b, c) {
                ...
                return new a(b, c, d)
            }, d = l("easing.RoughEase", function(a) {
                a = a || {};
                for (var c, d, e, f, g = a.taper || "none", h = [], k = 0, l = f = 0 | (a.points || 20), m = !1 !== a.randomize, n = !0 === a.clamp, p = a.template instanceof b ? a.template : null, B = "number" == typeof a.strength ? .4 * a.strength : .4; - 1 < --l;) a = m ? Math.random() : 1 / f * l, c = p ? p.getRatio(a) : a, "none" === g ? d = B : "out" === g ? (e = 1 - a, d = e * e * B) : "in" === g ? d = a * a * B : .5 > a ? (e = 2 * a, d = e * e * .5 * B) : (e = 2 *
                    (1 - a), d = e * e * .5 * B), m ? c += Math.random() * d - .5 * d : l % 2 ? c += .5 * d : c -= .5 * d, n && (1 < c ? c = 1 : 0 > c && (c = 0)), h[k++] = {
                    x: a,
                    y: c
                };
                h.sort(function(a, b) {
                ...
                d = new z(1, 1, null);
                for (l = f; - 1 < --l;) f = h[l], d = new z(f.x, f.y, d);
                this._prev = new z(0, 0, 0 !== d.t ? d : d.next)
            ...
            p("Bounce", h("BounceOut", function(a) {
                return 1 / 2.75 > a ? 7.5625 * a * a : 2 / 2.75 > a ? 7.5625 * (a -= 1.5 / 2.75) * a + .75 : 2.5 / 2.75 > a ? 7.5625 * (a -= 2.25 / 2.75) * a + .9375 : 7.5625 * (a -= 2.625 / 2.75) * a + .984375
            }), h("BounceIn", function(a) {
                return (a = 1 - a) < 1 / 2.75 ? 1 - 7.5625 * a * a : 2 / 2.75 > a ? 1 - (7.5625 * (a -= 1.5 / 2.75) * a + .75) : 2.5 / 2.75 > a ? 1 - (7.5625 * (a -= 2.25 / 2.75) * a + .9375) : 1 - (7.5625 * (a -= 2.625 / 2.75) * a + .984375)
            }), h("BounceInOut", function(a) {
                var b = .5 > a;
            ...
            })), p("Circ", h("CircOut", function(a) {
                return Math.sqrt(1 - --a * a)
            }), h("CircIn", function(a) {
                return -(Math.sqrt(1 - a * a) - 1)
            }), h("CircInOut", function(a) {
                return 1 > (a *= 2) ? -.5 * (Math.sqrt(1 - a * a) - 1) : .5 * (Math.sqrt(1 - (a -= 2) * a) + 1)
            })), f = function(a, c, d) {
                var e = l("easing." + a, function(a, b) {
                    this._p1 = 1 <= a ? a : 1;
            ...
            }, p("Elastic", f("ElasticOut", function(a) {
            ...
            }, .45)), p("Expo", h("ExpoOut", function(a) {
                    return 1 - Math.pow(2, -10 * a)
                }),
                h("ExpoIn", function(a) {
                    return Math.pow(2, 10 * (a - 1)) - .001
                }), h("ExpoInOut", function(a) {
                    return 1 > (a *= 2) ? .5 * Math.pow(2, 10 * (a - 1)) : .5 * (2 - Math.pow(2, -10 * (a - 1)))
                })), p("Sine", h("SineOut", function(a) {
                return Math.sin(a * k)
            }), h("SineIn", function(a) {
                return -Math.cos(a * k) + 1
            }), h("SineInOut", function(a) {
                return -.5 * (Math.cos(Math.PI * a) - 1)
            })), l("easing.EaseLookup", {
                find: function(a) {
                    return b.map[a]
                }
            }, !0), n(e.SlowMo, "SlowMo", "ease,"), n(d, "RoughEase", "ease,"), n(c, "SteppedEase", "ease,"), B
    }, !0)
});
_gsScope._gsDefine && _gsScope._gsQueue.pop()();
(function(b, c) {
    ...
    var g, k, l, h, n = function(a) {
        ...
        r = function(d, e, g, h) {
            ...
            this.check = function(l) {
                for (var p, q, O, y, x = e.length, z = x; - 1 < --x;)(p = m[e[x]] || new r(e[x], [])).gsClass ? (k[x] = p.gsClass, z--) : l && p.sc.push(this);
                if (0 === z && g) {
                    if (q = ("com.greensock." + d).split("."), O = q.pop(), y = n(q.join("."))[O] = this.gsClass = g.apply(g, k), h)
                        if (f[O] = a[O] = y, "undefined" != typeof module && module.exports)
                            if (d === c)
                                for (x in module.exports = a[c] = y, a) y[x] = a[x];
                            else a[c] &&
                                (a[c][O] = y);
    ...
    q.globals = f;
    var X = [0, 0, 1, 1],
        T = y("easing.Ease", function(a, b, c, d) {
            this._func = a;
            this._type = c || 0;
            this._power = d || 0;
        ...
        L = T.map = {},
        I = T.register = function(a, b, c, d) {
            var e, f, g;
            b = b.split(",");
            for (var h = b.length, k = (c || "easeIn,easeOut,easeInOut").split(","); - 1 < --h;)
                for (e = b[h], c = d ? y("easing." + e, null, !0) : p.easing[e] || {}, f = k.length; - 1 < --f;) g = k[f], L[e + "." + g] = L[g + e] = c[g] = a.getRatio ? a : a[g] || new a
        },
        e = T.prototype;
    e._calcEnd = !1;
    ...
    for (k = g.length; - 1 < --k;) e = g[k] + ",Power" + k, I(new T(null, null, 1, k), e, "easeOut", !0), I(new T(null, null, 2, k), e, "easeIn" + (0 === k ? ",easeNone" : "")), I(new T(null, null, 3, k), e, "easeInOut");
    L.linear = p.easing.Linear.easeIn;
    L.swing = p.easing.Quad.easeInOut;
    var F = y("events.EventDispatcher", function(a) {
            this._listeners = {};
    ...
    var C = b.requestAnimationFrame,
        K = b.cancelAnimationFrame,
        G = Date.now || function() {
            return (new Date).getTime()
        },
        Q = G();
    g = ["ms", "moz", "webkit", "o"];
    for (k = g.length; - 1 < --k && !C;) C = b[g[k] + "RequestAnimationFrame"], K = b[g[k] + "CancelAnimationFrame"] || b[g[k] + "CancelRequestAnimationFrame"];
    y("Ticker", function(a, b) {
        ...
        m.lagSmoothing = function(a, b) {
            return arguments.length ? (q = a || 1E10, void(r = Math.min(b, q, 0))) : 1E10 > q
        };
        m.sleep = function() {
            null != f && (p && K ? K(f) : clearTimeout(f), e = B, f = null, m === l && (h = !1))
        };
        m.wake = function(a) {
            null !== f ? m.sleep() : a ? n += -Q + (Q = G()) : 10 < m.frame && (Q = G() - q + 5);
            e = 0 === c ? B : p && C ? C : function(a) {
        ...
        m.useRAF = function(a) {
            return arguments.length ? (m.sleep(), p = a, void m.fps(c)) : p
        };
        m.fps(a);
        setTimeout(function() {
            "auto" === p && 5 > m.frame && "hidden" !== (d || {}).visibilityState && m.useRAF(!1)
        }, 1500)
    });
    e = p.Ticker.prototype = new p.events.EventDispatcher;
    e.constructor = p.Ticker;
    var J = y("core.Animation", function(a, b) {
    ...
    e._paused = !1;
    var W = function() {
        h && 2E3 < G() - Q && ("hidden" !== (d || {}).visibilityState || !l.lagSmoothing()) && l.wake();
    ...
    e._enabled = function(a, b) {
        return h || l.wake(), this._gc = !a, this._active = this.isActive(), !0 !== b && (a && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !a && this.timeline && this._timeline._remove(this, !0)), !1
    };
    ...
    e.paused = function(a) {
        ...
        return a != this._paused && d && (h || a || l.wake(), b = d.rawTime(), c = b - this._pauseTime, !a && d.smoothChildTiming && (this._startTime += c, this._uncache(!1)), this._pauseTime = a ? b : null, this._paused = a, this._active = this.isActive(), !a && 0 !== c && this._initted && this.duration() && (b = d.smoothChildTiming ?
            this._totalTime : (b - this._startTime) / this._timeScale, this.render(b, b === this._totalTime, !0))), this._gc && !a && this._enabled(!0, !1), this
    };
    g = y("core.SimpleTimeline", function(a) {
        J.call(this, 0, a);
    ...
    e.rawTime = function() {
        return h ||
            l.wake(), this._totalTime
    };
    var D = y("TweenLite", function(a, c, d) {
            if (J.call(this, c, d), this.render = D.prototype.render, null == a) throw "Cannot tween a null target.";
            ...
            if (this._overwrite = d = null == d ? pa[D.defaultOverwrite] : "number" == typeof d ? d >> 0 : pa[d], (e || a instanceof Array || a.push && V(a)) && "number" != typeof a[0])
                for (this._targets = f = z(a), this._propLookup = [], this._siblings = [], a = 0; a < f.length; a++)(e = f[a]) ? "string" != typeof e ? e.length && e !== b && e[0] && (e[0] === b || e[0].nodeType && e[0].style && !e.nodeType) ? (f.splice(a--, 1), this._targets = f = f.concat(z(e))) : (this._siblings[a] = Ca(e, this, !1), 1 === d && 1 < this._siblings[a].length && xa(e, this, null, 1, this._siblings[a])) : (e = f[a--] = D.selector(e), "string" == typeof e && f.splice(a + 1, 1)) : f.splice(a--, 1);
    ...
    D.version = "2.0.1";
    D.defaultEase = e._ease = new T(null, null, 1, 1);
    ...
    D.selector = b.$ || b.jQuery || function(a) {
        var c = b.$ || b.jQuery;
        return c ? (D.selector = c, c(a)) : (d || (d = b.document), d ? d.querySelectorAll ? d.querySelectorAll(a) : d.getElementById("#" === a.charAt(0) ? a.substr(1) : a) : a)
    };
    var Z = [],
        na = {},
        ha = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        ...
        la = function(a, b, c, d) {
            ...
            return m += b.substr(l), m && k.push(m), k.setRatio = x, H.test(b) && (k.end = null), k
        },
        ma = function(a, b, c, d, e, f, g, h, k) {
            ...
            return ("number" != typeof c || "number" != typeof d && !m) && (g || isNaN(c) || !m && isNaN(d) || "boolean" == typeof c || "boolean" == typeof d ? (a.fp = g, l = la(c, m ? parseFloat(a.s) + a.c + (a.s + "").replace(/[0-9\-\.]/g, "") : d, h || D.defaultStringFilter, a), a = {
                t: l,
                p: "setRatio",
                s: 0,
                c: 1,
    ...
    var Y = D._plugins = {},
        ...
        ka = J._rootFramesTimeline = new g,
        aa = J._rootTimeline = new g,
        E = 30,
    ...
    aa._startTime = l.time;
    ka._startTime =
        l.frame;
    aa._active = ka._active = !0;
    setTimeout(va, 1);
    J._updateRoot = D.render = function() {
        var a, b, c;
        if (Z.length && va(), aa.render((l.time - aa._startTime) * aa._timeScale, !1, !1), ka.render((l.frame - ka._startTime) * ka._timeScale, !1, !1), Z.length && va(), l.frame >= E) {
            E = l.frame + (parseInt(D.autoSleep, 10) || 120);
            for (c in ca) {
                b = ca[c].tweens;
                for (a = b.length; - 1 < --a;) b[a]._gc && b.splice(a, 1);
                0 === b.length && delete ca[c]
            }
            if (c = aa._first, (!c || c._paused) && D.autoSleep && !ka._first && 1 === l._listeners.tick.length) {
    ...
    var Ca = function(a, b, c) {
            ...
            if (ca[f || (a._gsTweenID = f = "t" + ia++)] || (ca[f] = {
                    target: a,
                    tweens: []
        ...
        Fa = function(a, b, c, d) {
            ...
            return g && (e = g(a, b, c, d)), g = D.onOverwrite, g && (f = g(a, b, c, d)), !1 !== e && !1 !== f
        },
        xa = function(a, b, c, d, e) {
            ...
            var k, l = b._startTime + 1E-10,
                ...
                n = 0,
                p = 0 === b._duration;
            for (f = e.length; - 1 < --f;)(h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (k = k || oa(b, 0, p), 0 === oa(h, k, p) && (m[n++] = h)) : h._startTime <= l && h._startTime + h.totalDuration() / h._timeScale > l && ((p || !h._initted) && 2E-10 >= l - h._startTime || (m[n++] = h)));
            for (f = n; - 1 < --f;)(h = m[f], 2 === d && h._kill(c, a, b) && (g = !0), 2 !== d || !h._firstPT && h._initted) && (2 === d || Fa(h, b)) && h._enabled(!1, !1) && (g = !0);
            return g
        },
        oa = function(a, b, c) {
            for (var d =
                    a._timeline, e = d._timeScale, f = a._startTime; d._timeline;) {
    ...
    e._init = function() {
        ...
        if (e.startAt) {
            ...
            if (c.data = "isStart",
                c.overwrite = !1, c.immediateRender = !0, c.lazy = d && !1 !== e.lazy, c.startAt = c.delay = null, c.onUpdate = e.onUpdate, c.onUpdateParams = e.onUpdateParams, c.onUpdateScope = e.onUpdateScope || e.callbackScope || this, this._startAt = D.to(this.target || {}, 0, c), d)
            ...
            if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                ...
                if (c.overwrite = 0, c.data =
                    "isFromStart", c.lazy = d && !1 !== e.lazy, c.immediateRender = d, this._startAt = D.to(this.target, 0, c), d) {
                    if (0 === this._time) return
                } else this._startAt._init(), this._startAt._enabled(!1), this.vars.immediateRender && (this._startAt = null)
            }
        if (this._ease = h = h ? h instanceof T ? h : "function" == typeof h ? new T(h, e.easeParams) : L[h] || D.defaultEase : D.defaultEase, e.easeParams instanceof Array && h.config && (this._ease = h.config.apply(h, e.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null,
            this._targets)
        ...
        if (b && D._onPluginEvent("_onInitAllProps", this), f && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), e.runBackwards)
            for (c = this._firstPT; c;) c.s += c.c, c.c = -c.c, c = c._next;
        this._onUpdate = e.onUpdate;
        this._initted = !0
    };
    e._initProps = function(a, c, d, e, f) {
        var g, h, k, l, m;
        if (null ==
            a) return !1;
        na[a._gsTweenID] && va();
        ...
        for (g in this.vars)
            ...
            else if (Y[g] && (l = new Y[g])._onInitTween(a,
                this.vars[g], this, f)) {
            this._firstPT = m = {
                _next: this._firstPT,
                t: l,
        ...
        return e && this._kill(e, a) ? this._initProps(a, c, d, e, f) : 1 < this._overwrite && this._firstPT && 1 < d.length && xa(a, this,
            c, this._overwrite, d) ? (this._kill(c, a), this._initProps(a, c, d, e, f)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (na[a._gsTweenID] = !0), k)
    };
    e.render = function(a, b, c) {
        var d, e, f, g, h = this._time,
            k = this._duration;
        f = this._rawPrevTime;
        if (a >= k - 1E-7 && 0 <= a) this._totalTime = this._time = k, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = "onComplete", c = c || this._timeline.autoRemoveChildren), 0 === k && (this._initted || !this.vars.lazy || c) && (this._startTime ===
            this._timeline._duration && (a = 0), (0 > f || 0 >= a && -1E-7 <= a || 1E-10 === f && "isPause" !== this.data) && f !== a && (c = !0, 1E-10 < f && (e = "onReverseComplete")), this._rawPrevTime = g = !b || a || f === a ? a : 1E-10);
        else if (1E-7 > a) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== h || 0 === k && 0 < f) && (e = "onReverseComplete", d = this._reversed), 0 > a && (this._active = !1, 0 === k && (this._initted || !this.vars.lazy || c) && (0 <= f && (1E-10 !== f || "isPause" !== this.data) && (c = !0), this._rawPrevTime = g = !b || a || f === a ? a : 1E-10)), (!this._initted ||
            this._startAt && this._startAt.progress()) && (c = !0);
        ...
        if (this._time !== h || c) {
            if (!this._initted) {
                if (this._init(), !this._initted || this._gc) return;
                if (!c && this._firstPT && (!1 !== this.vars.lazy &&
                        this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = h, this._rawPrevTime = f, Z.push(this), void(this._lazy = [a, b]);
            ...
            0 !== h || (this._startAt && (0 <= a ? this._startAt.render(a, !0, c) : e || (e = "_dummyGS")), !this.vars.onStart || 0 === this._time && 0 !== k || !b &&
            ...
            e && (!this._gc || c) && (0 > a && this._startAt && !this._onUpdate && -1E-4 !== a && this._startAt.render(a, !0, c), d && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !b && this.vars[e] && this._callback(e), 0 === k && 1E-10 === this._rawPrevTime && 1E-10 !==
                g && (this._rawPrevTime = 0))
        }
    };
    e._kill = function(a, b, c) {
        if ("all" === a && (a = null), null == a && (null == b || b === this.target)) return this._lazy = !1, this._enabled(!1, !1);
        b = "string" != typeof b ? b || this._targets || this.target : D.selector(b) || b;
        var d, e, f, g, h, k, l, m, n = c && this._time && c._startTime === this._startTime && this._timeline === c._timeline;
        if ((V(b) || ea(b)) && "number" != typeof b[0])
            ...
            if (h) {
                if (d = a || h, l = a !== e && "all" !== e && a !== h && ("object" != typeof a || !a._tempKill), c && (D.onOverwrite || this.vars.onOverwrite)) {
                    for (f in d) h[f] && (m || (m = []), m.push(f));
                    if ((m || !a) && !Fa(this, c, b, m)) return !1
                }
                for (f in d)(g = h[f]) && (n && (g.f ? g.t[g.p](g.s) : g.t[g.p] = g.s, k = !0), g.pg &&
                    g.t._kill(d) && (k = !0), g.pg && 0 !== g.t._overwriteProps.length || (g._prev ? g._prev._next = g._next : g === this._firstPT && (this._firstPT = g._next), g._next && (g._next._prev = g._prev), g._next = g._prev = null), delete h[f]), l && (e[f] = 1);
    ...
    e.invalidate = function() {
        return this._notifyPluginsOfEnabled && D._onPluginEvent("_onDisable", this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup =
            this._targets ? {} : [], J.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -1E-10, this.render(Math.min(0, -this._delay))), this
    };
    e._enabled = function(a, b) {
        if (h || l.wake(), a && this._gc) {
            var c, d = this._targets;
            if (d)
                for (c = d.length; - 1 < --c;) this._siblings[c] = Ca(d[c], this, !0);
            else this._siblings = Ca(this.target, this, !0)
        }
        return J.prototype._enabled.call(this, a, b), this._notifyPluginsOfEnabled && this._firstPT ? D._onPluginEvent(a ? "_onEnable" : "_onDisable", this) : !1
    };
    D.to = function(a, b, c) {
        return new D(a,
            b, c)
    ...
    D.fromTo = function(a, b, c, d) {
        return d.startAt = c, d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender, new D(a, b, d)
    };
    D.delayedCall = function(a, b, c, d, e) {
        return new D(b, 0, {
            delay: a,
            onComplete: b,
            onCompleteParams: c,
    ...
    D.getTweensOf = function(a,
        b) {
        if (null == a) return [];
        a = "string" != typeof a ? a : D.selector(a) || a;
        var c, d, e, f;
        if ((V(a) || ea(a)) && "number" != typeof a[0]) {
            c = a.length;
            for (d = []; - 1 < --c;) d = d.concat(D.getTweensOf(a[c], b));
            for (c = d.length; - 1 < --c;)
    ...
    D.killTweensOf = D.killDelayedCallsTo = function(a, b, c) {
        "object" == typeof b && (c = b, b = !1);
        b = D.getTweensOf(a, b);
        for (var d = b.length; - 1 < --d;) b[d]._kill(c,
            a)
    };
    var ba = y("plugins.TweenPlugin", function(a, b) {
        this._overwriteProps = (a || "").split(",");
        this._propName = this._overwriteProps[0];
        this._priority = b || 0;
        this._super = ba.prototype
    }, !0);
    if (e = ba.prototype, ba.version = "1.19.0", ba.API = 2, e._firstPT = null, e._addTween = ma, e.setRatio = x, e._kill = function(a) {
            var b, c = this._overwriteProps,
                d = this._firstPT;
            if (null != a[this._propName]) this._overwriteProps = [];
            else
                for (b = c.length; - 1 < --b;) null != a[c[b]] && c.splice(b, 1);
            for (; d;) null != a[d.n] && (d._next && (d._next._prev = d._prev), d._prev ?
                (d._prev._next = d._next, d._prev = null) : this._firstPT === d && (this._firstPT = d._next)), d = d._next;
            return !1
            ...
            var b, c = a.propName,
                ...
                g = y("plugins." + c.charAt(0).toUpperCase() +
                    c.substr(1) + "Plugin",
                    function() {
                        ba.call(this, c, d);
...
(function() {
    ...
    function ea(a) {
        return "display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + X(a.c) + ";" + ("font-style:" + L(a) + ";font-weight:" + (a.f + "00") + ";")
    }
    ...
    function ha() {
        if (null === M) {
            ...
            M = !!a && (536 > parseInt(a[1], 10) || 536 === parseInt(a[1], 10) && 11 >= parseInt(a[2], 10))
        }
        return M
    }
    ...
    function x(a) {
        var b = a.g.a.offsetWidth,
            c = a.h.a.offsetWidth,
            d;
        (d = b === a.f.serif && c === a.f["sans-serif"]) || (d = ha() && H(a, b, c));
        d ? w() - a.A >= a.w ? ha() && H(a, b, c) && (null === a.u || a.u.hasOwnProperty(a.a.c)) ? ma(a, a.v) : ma(a, a.B) : la(a) : ma(a, a.v)
    }
    ...
    function ca(a) {
        0 == --a.f && a.j && (a.m ? (a = a.a, a.g && k(a.f, [a.a.c("wf", "active")], [a.a.c("wf", "loading"), a.a.c("wf", "inactive")]), G(a, "active")) : K(a.a))
    }
            ...
            if (0 === d.length && g) K(c.a);
                ...
                for (l = 0; l < d.length; l++) {
                    var n = d[l],
                        ...
                        p = c.a,
                        q = n;
                    p.g && k(p.f, [p.a.c("wf", q.c, T(q).toString(), "loading")]);
                    G(p, "fontloading", q);
                    p = null;
                    if (null === R)
                        if (window.FontFace) {
                            var q = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
                                r = /OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent) &&
                                /Apple/.exec(window.navigator.vendor);
                            R = q ? 42 < parseInt(q[1], 10) : r ? !1 : !0
                        } else R = !1;
                    R ? p = new Z(a(c.g, c), a(c.h, c), c.c, n, c.s, v) : p = new na(a(c.g, c), a(c.h, c), c.c, n, c.s, b, v);
                    m.push(p)
                }
    ...
    function xa(a) {
        for (var b = a.f.length, c = 0; c < b; c++) {
            ...
            if (2 <= d.length) {
                ...
                0 < g.length && (f = g);
                3 == d.length && (d = d[2], g = [], d = d ? d.split(",") : g, 0 < d.length && (d = S[d[0]]) && (a.c[e] = d))
            }
            a.c[e] || (d = S[e]) && (a.c[e] = d);
    ...
    Z.prototype.start = function() {
        var a = this.c.o.document,
            ...
            d = new Promise(function(d, e) {
                function f() {
                    w() - c >= b.f ? e() : a.fonts.load(y(b.a), b.h).then(function(a) {
    ...
    Y.prototype.h = function(a) {
        var b = this.a;
        if (b.g) {
            var c = l(b.f, b.a.c("wf", a.c, T(a).toString(), "active")),
                d = [],
    ...
    ka.prototype.load = function(a) {
        ...
        if (d) {
            var f = c.c.o;
            p(this.c, (c.a.api || "https://fast.fonts.net/jsapi") +
                "/" + d + ".js" + (e ? "?v=" + e : ""),
                function(e) {
    ...
    aa.prototype.load = function(a) {
        var b, c, d = this.a.urls || [],
            ...
            g = new z;
        b = 0;
        for (c = d.length; b < c; b++) n(this.c, d[b], B(g));
        var h = [];
        b = 0;
    ...
    oa.prototype.load = function(a) {
        var b = new z,
            c = this.c,
            d = new E(this.a.api, this.a.text),
            e = this.a.families;
        va(d, e);
        var f = new Fa(e);
        xa(f);
    ...
    ba.prototype.load = function(a) {
        var b = this.a.id,
            c = this.c.o;
        b ? p(this.c, (this.a.api || "https://use.typekit.net") + "/" + b + ".js", function(b) {
            if (b) a([]);
        ...
        b ? (c.__webfontfontdeckmodule__ || (c.__webfontfontdeckmodule__ = {}), c.__webfontfontdeckmodule__[b] = function(b, c) {
            for (var e = 0, f = c.fonts.length; e < f; ++e) {
                ...
                d.a.push(new q(g.name,
                    I("font-weight:" + g.weight + ";font-style:" + g.style)))
            }
            a(d.a)
        }, p(this.c, (this.f.api || "https://f.fontdeck.com/s/css/js/") + h(this.c) + "/" + b + ".js", function(b) {
            b && a([])
        })) : a([])
    };
    var Ba = new ia(window);
...
(function(b) {
    b.svenPlugin = function(c, a) {
        ...
        function f(a, d, e, g, h) {
            d.each(function(k, l) {
                if (k == a || E.preloadScenes) {
                    var m = b(this).data(),
                        n = E.preloadScenes ? N[O] : new TimelineMax({
                            paused: !0
                        });
                    ...
                    "undefined" == typeof m.freezeTime && (m.freezeTime = E.globalFreeze);
                    ...
                    q.wrap("<div class='sven-scene " + p + "'><div class='centered " + m.alignment + "'></div></div>");
                    p = q.find("h1");
                    k == e - 1 && (m.outDur = "none", Ta = b(this).attr("id"));
                    var r = b(this).prev();
                    G(b(this), k, r, m, n);
                    J(b(this), k, m, q, p, n);
                    E.preloadScenes || (TweenMax.delayedCall(E.queueDelay, f, [a + 1, d, e]), N[O].add(n.play()));
                    if (0 == a && !E.preloadScenes || E.preloadScenes)
                        if (!qb && ("video-bg" === R && "youtube" === Qa || La && 0 < M.length)) ta.on("YTPReady YTPError", function() {
                            b.isFunction(E.onTeaserReady) &&
                                E.onTeaserReady.call(c);
                            b("body").addClass("set-overflow");
                            !Da && Ea && ib && b(".pl-sound").parent().hide();
                            "video-bg" === R && "youtube" === Qa && Za.css({
                                opacity: "0",
                                visibility: "hidden"
                            });
                        ...
                        else !Da && Ea && ib && b(".pl-sound").parent().hide(), b.isFunction(E.onTeaserReady) && E.onTeaserReady.call(c), b("body").addClass("set-overflow"), "video-bg" === R && "youtube" === Qa && Za.css({
                                opacity: "0",
                                visibility: "hidden"
                            }), g ? (va = "playing", aa.play(h)) :
                            (va = "paused", aa.seek(h));
                    k != e - 1 || E.preloadScenes || N[O].set({}, {
                        immediateRender: !1,
                        onComplete: F
                    })
                }
        ...
        function e() {
            w = "xhr" === E.preloadMethod ? new createjs.LoadQueue : new createjs.LoadQueue(!1);
            w.setMaxConnections(500);
            w.on("progress", k);
            w.on("fileload", l);
            w.on("complete", p);
            w.on("error", n);
            w.on("fileerror", h);
            Da && !Ab && (w.installPlugin(createjs.Sound), "tag" == E.preloadMethod && createjs.Sound.registerPlugins([createjs.HTMLAudioPlugin]), createjs.Sound.alternateExtensions = ["ogg"], w.loadFile({
                id: vb,
                family: "sound-file",
                src: Fb,
                loadTimeout: E.audioTimeout
            }));
            0 < u.length && w.loadManifest(u)
        }

        function g() {
            Fa = !0;
            fa = createjs.Sound.play(vb);
            fa.loop = wa;
            isChrome && !ua && (fa.position = 100);
            fa.on("complete", V);
            oa ? N[O].paused() || ba ? fa.paused = !0 : B() : fa.paused = !0
        }

        function k(a) {
            a = Math.round(100 * a.loaded);
            E.triggerProgress && c.trigger("PLProgress", [a]);
            a >= E.initAfter && Fa && !U && z()
        }
        ...
        function l(a) {
            ...
            switch (c.family) {
                ...
                case "sound-file":
                    ...
                    fa.on("complete", V);
                    setTimeout(function() {
                        100 < fa.position && (t = !0, b(".sound-info").hide(), b(".pl-sound").parent().removeClass("highlight"));
                        fa.paused = !0
                    }, 4);
                    break;
                case "static-image":
        ...
        function z() {
            U += 1;
            E.autoStart && t ? c.trigger("STUnMuted") : c.trigger("STMuted");
        ...
        function B() {
            ...
            if ("undefined" !== typeof fa) {
                var a = Math.round(fa.duration),
                    b = Math.round(1E3 * N[O].totalTime().toFixed(1) / N[O].timeScale()),
                    d = b;
                0 > wa && b > a && (d = b % a);
                fa.position = d;
                c.trigger("STUnMuted")
        ...
        function T(a, d, e) {
            d.data().sceneImage && (d = w.getItem(d[0].id).src, Za.css("background-image", "url(" + d + ")"));
            Za.css({
                opacity: "1",
                visibility: "visible"
            });
            if ("html5" ===
                ...
                }); - 1 == P.currentSrc().indexOf(f[0].videoURL) && cb.show(f[0].videoURL);
                P.off("timeupdate");
                P.off("ended");
                P.muted(f[0].mute);
                P.currentTime(f[0].startAt);
                P.muteEnabled = f[0].muteEnabled;
                if (kb)(1 < A.length && (kb = !1), L(), P.on("timeupdate", function() {
                        if (0 != f[0].stopAt && P.currentTime() >= f[0].stopAt || 0 == f[0].stopAt && P.currentTime() >= P.duration()) f[0].loop ? (P.loop(!0), P.currentTime(f[0].startAt), P.play()) : (Ja = !1, P.pause())
                    }),
                    P.play(), E.autoStart || P.muteEnabled) ? t && !P.muteEnabled && (c.trigger("STUnMuted"), P.muted(!1), P.volume(E.videoVolume)) : (c.trigger("STUnMuted"), P.muted(!1), P.volume(E.videoVolume));
                else P.one("loadeddata", function() {
                    L();
                    P.on("timeupdate", function() {
                        if (0 != f[0].stopAt && P.currentTime() >= f[0].stopAt || 0 == f[0].stopAt && P.currentTime() >= P.duration()) f[0].loop ? (P.loop(!0), P.currentTime(f[0].startAt), P.play()) : (Ja = !1, P.pause())
                    });
                    P.play();
                    E.autoStart || P.muteEnabled ? t && !P.muteEnabled && (c.trigger("STUnMuted"), P.muted(!1),
                        P.volume(E.videoVolume)) : (c.trigger("STUnMuted"), P.muted(!1), P.volume(E.videoVolume))
                })
            } else(Ja = !1, eb = !0, f = b.grep(M, function(b) {
                return b.sceneIndex == a
            }), f[0].videoURL == ta[0].opt.videoURL) ? (L(), sa.YTPSeekTo(f[0].startAt), tb.css("visibility", "visible"), sa.YTPPlay(), E.autoStart || f[0].muteEnabled) ? t && !f[0].muteEnabled && (c.trigger("STUnMuted"), sa.YTPUnmute(), ta.isMute = !1) : (c.trigger("STUnMuted"), sa.YTPUnmute(), ta.isMute = !1) : (f[0].autoPlay = !0, sa.changeMovie(f[0]), ta.one("YTPReady", function() {
                L();
                b(this).YTPSeekTo(f[0].startAt);
                tb.css("visibility", "visible");
                b(this).YTPPlay();
                E.autoStart || f[0].muteEnabled ? t && !f[0].muteEnabled && (c.trigger("STUnMuted"), sa.YTPUnmute(), ta.isMute = !1) : (c.trigger("STUnMuted"), sa.YTPUnmute(), ta.isMute = !1)
            }))
        }
        ...
        function I() {
            oa = !0;
            b.isFunction(E.onTeaserStart) && E.onTeaserStart.call(c);
            wb.hide();
            E.freezeOnBlur && (ifvisible.on("blur", function() {
                aa.freezeTeaser()
            }), ifvisible.on("focus", function() {
                aa.continueTeaser()
            }));
            "undefined" !== typeof fa && ((!ua ||
                ua && !E.autoStart) && xb && "paused" != Ha || "playing" === Ha ? (B(), t ? (fa.volume = E.standaloneAudioVolume, fa.paused = !1, c.trigger("STUnMuted"), Ha = "playing") : (fa.volume = E.standaloneAudioVolume, fa.paused = !0, c.trigger("STMuted"), Ha = "paused")) : (fa.volume = E.standaloneAudioVolume, fa.paused = !0, c.trigger("STMuted"), Ha = "paused"));
            "single-image" === R && Ma.paused() && Ma.resume();
            "video-bg" !== R || (q(rb), "youtube" === Qa && tb.css("visibility", "visible"), r(), Da) || ("undefined" == typeof P || Ea ? "undefined" == typeof ta || Ea || (E.autoStart ?
                ta.isMute ? c.trigger("STMuted") : c.trigger("STUnMuted") : (c.trigger("STUnMuted"), sa.YTPUnmute(), ta.isMute = !1)) : E.autoStart ? P.muted() ? c.trigger("STMuted") : c.trigger("STUnMuted") : (c.trigger("STUnMuted"), P.muted(!1), P.volume(E.videoVolume)))
        }

        function F() {
            ba = !0;
            c.trigger("STEnd");
            "undefined" !== typeof fa && Va && V();
            ("video-bg" === R && Ka || "assorted" === R && E.stopTeaserOnEnd) && m();
            b.isFunction(E.onTeaserEnd) && E.onTeaserEnd.call(c)
        }
        ...
        function G(a, c, d, e, f) {
            var g = e.trans,
                ...
                k = a.attr("id"),
                l, m = !1;
            0 == c ? (d = b(".extinct"), l = "sven-nothing") : l = d.attr("id");
            if ("no" == e.pursueImage) {
                var n = Ia.find("." + k + " img");
                l = Ia.find("." + l + " img, ." + ya + " img");
                ja = n;
                ya = k
            } else n = ja, l = b(".sven-not-found");
            ...
            h /= 2;
            p = b.grep(svenTransitions.vegas, function(a) {
                return a.name == g
            });
            0 != c && b.grep(svenTransitions.vegas, function(a) {
                return a.name == d.data().trans
            });
            "fade-screen" == p[0].template ? (f.to(Bb, h, {
                    autoAlpha: 1,
            ...
            S[k] = new TimelineMax;
            S[k + "-alpha"] = new TimelineMax;
            "no" == e.pursueImage && S[k + "-alpha"].to(n, r, {
                autoAlpha: 1
            }, 0);
            "fade-screen" == p[0].template && S[k + "-alpha"].to(Bb, h, {
                autoAlpha: 0
            }, 0);
            S[k].data = {};
            S[k].data.duration = p[0].in[0].duration ? p[0].in[0].duration : "full";
            S[k].fromTo(n, 1.08, p[0].in[0].from, p[0].in[0].to, 0);
            0 < l.length && S[k + "-alpha"].set(l, {
                autoAlpha: 0
            });
            "prior" == q && (h = p[0].in[0].duration ? p[0].in[0].duration : 1.5, f.add(S[k + "-alpha"], k + "-label"), f.add(S[k].duration(h), k + "-label"));
            m && f.set({}, {
                    immediateRender: !1,
                    onStart: Q,
                    onStartParams: []
        ...
        function J(a, c, d, e, f, g) {
            var h = W(a, d, e, f),
                ...
                t = d.cinPattern ? d.cinPattern : "sequential",
                u = d.coutPattern ? d.coutPattern : "reverse";
            f = f.get().slice(0);
            t =
                sortArray(t, f);
            u = sortArray(u, f);
            ...
            "none" != d.outDur && b.each(u, function(a, c) {
                if (0 < a) var d = "cont-out-" + m;
                var e = b(c).data("order");
                m = e;
                var f = "cont-out-" + e;
                k[f] = new TimelineMax;
                var g = D(b(c), e, h, "out");
                ea(b(c), e, h, g, N[O], k, k[f], "out");
                g.duration && k[f].duration(g.duration);
                g.timeScale && k[f].timeScale(g.timeScale);
        ...
        function W(a, c, d, e) {
            ...
            var g = a.find(".centered"),
                h = g.css("max-width");
            0 <= h.indexOf("%") &&
                (h = parseFloat(h) / 100, h = Math.ceil(Ba * h) + "px");
            a = a.children();
            var k;
            ...
            e.each(function(a, e) {
                ...
                var g = qa(b(this)),
                    ...
                    n = b(this).data().boxType ? b(this).data().boxType : "contain",
                    p = b(this).data().delimiter ?
                    b(this).data().delimiter : " ",
                ...
                var u = q.animation,
                    v = r.animation,
                    u = svenAnimations[u] ? svenAnimations[u] : svenAnimations["fade-in"],
                    v = svenAnimations[v] ? svenAnimations[v] : svenAnimations["fade-out"];
                f["inConfig" + a] = u;
                f["outConfig" + a] = v;
                u.inherit && (f["inConfig" + a] = b.extend(!0, {}, svenAnimations[u.inherit], f["inConfig" + a]));
                v.inherit && (f["outConfig" + a] = b.extend(!0, {}, svenAnimations[v.inherit], f["outConfig" + a]));
                var x;
                x = E.easeOuterGPU ? "" : "gpu-hack";
                ...
                if ("whole" == q.animateBy && "whole" == r.animateBy || "whole" == u.animateBy && "whole" == v.animateBy || b(this).find("img, a").length || "glitch" == q.animation) {
                    ...
                    q = -1 < n.indexOf("chars") ? "words,chars,lines" :
                        "words,lines";
                    r = E.easeOuterGPU ? "" : "gpu-hack";
                    f["split" + a] = new SplitText(b(this), {
                        type: q,
                        wordsClass: "s-word " + r + " sven-word-++",
                        charsClass: "s-char sven-char-++",
                        linesClass: "s-line " + r + " sven-line-++",
                        wordDelimiter: p,
                        position: "absolute"
                    });
                    ...
                    b(this).removeClass("place-left").addClass(m);
                    w = 0;
                    var y, da, Wa = f["split" + a].lines.length;
                    b.each(f["split" + a].lines, function(a, c) {
                        var d = b(c).children().last();
                        y = parseInt(d.css("left")) + parseInt(d.css("width"));
                        b(c).css({
                            width: y + "px",
                            right: g.padRight + "px"
                        }).addClass(m);
                        y > w && (w = y);
                        a == Wa - 1 && (da = parseInt(b(this).css("top")) + parseInt(b(this).css("height")))
                    });
                    b(this).css({
                        width: w + g.horz + "px",
                        height: da + g.padBottom + "px"
                    });
                    f["wrapper" + a].css({
                        height: da + g.padBottom + g.marTop + g.marBottom + "px"
                    });
                    w > l && (l = w + g.horz)
                }
            });
        ...
        function D(a, c, d, e) {
            var f = {},
                g, h, k = d["split" + c];
            "in" == e ? (e = readCustomOptions(a.data().sin), g = d["inConfig" + c], h = "fade-in") : (e = readCustomOptions(a.data().sout),
                g = d["outConfig" + c], h = "fade-out");
            f.animTitle = e.animation ? e.animation : h;
            f.animTemplate = e.template ? e.template : g.template;
            "rotator" == f.animTemplate ? (g = b.extend({}, svenDefaults.rotator, g), d["outConfig" + c] = b.extend({}, svenDefaults.rotator, {
                template: "rotator"
            })) : g = b.extend({}, svenDefaults.basic, g);
            ...
            f.staggerDur = e.staggerDur ? parseFloat(e.staggerDur) : g.staggerDur;
        ...
        function ea(a, b, c, d, e, f, g, h) {
            ...
            switch (k) {
                case "basic":
                    ...
                    break;
                case "misc":
                    "in" == h && ha(a, b, c, d, e, f, g, "in");
                    break;
                case "rotator":
                    "in" == h && na(a, b, c, d, e, g, "in");
                    break;
                default:
                    console.log('Please check your custom animation "' + k + '" have "template" mentioned in sven-animations.js'), Z(a, b, c, d, e, g, h)
            }
        }
        ...
        function Z(a, c, d, e, f, g, h) {
            ...
            if (is.obj(k.opacity) || is.obj(l.opacity)) m.opacity = is.obj(k.opacity) ? k.opacity.value : k.opacity, n.opacity =
                is.obj(l.opacity) ? l.opacity.value : l.opacity, k.opacity.ease && (m.ease = parseEase(k.opacity.ease)), inToObj.opacity.ease && (n.ease = parseEase(l.opacity.ease));
            var p = "basic-" + c,
                q = a.length;
        ...
        function na(a, c, d, e, f, g, h) {
            ...
            var l = d["inConfig" + c].rotIn.addTweens,
                ...
                y = {},
                z = {};
            if (is.obj(t.opacity) || is.obj(u.opacity)) y.opacity = is.obj(t.opacity) ? t.opacity.value : t.opacity, z.opacity = is.obj(u.opacity) ? u.opacity.value : u.opacity, t.opacity.ease && (y.ease = parseEase(t.opacity.ease)), u.opacity.ease && (z.ease = parseEase(u.opacity.ease));
            b.each(a, function(a, c) {
                var d = k;
                ...
                (0 < a || 0 == a && e.firstIn) && b.each(f, function(a, c) {
                    ...
                    b.isEmptyObject(y) || g.fromTo(b(c), f, y, z, e);
        ...
        function ha(a, c, d, e, f, g, h, k) {
            ...
            d.each(function(a, c) {
                f.set(b(c), {
                    ...
                    x: 0,
                    opacity: 1,
                    clip: "rect(" + l * a + "px, " + m + "px, " + l * (a + 1) + "px, 0px)"
                })
            });
            f.set(c, {
                autoAlpha: 0
            ...
            H(g["in"], g.repeat, d, 1, !1, "+=0.1");
            H(g["in"], g.repeat, d, .5, !1, "+=0.4");
            H(g["in"], g.repeat, d, .5, !0, "+=3");
            H(g["in"], g.repeat, d, .5, !1, "+=0.4");
            H(g["in"], g.repeat, d, .5, !1, "+=2");
            g["in"].to(d, .25, {
                x: 0,
                opacity: 1,
                ease: RoughEase.ease.config({
        ...
        function x(a, c, d, e, f, g, h, k, l) {
            if ("opacity" != e || b.isEmptyObject(h)) "addTweens" == e && is.fnc(f) ? f(a, c, d, k, l) : g[e] = is.fnc(f) ? f(a, c) : f
        }

        function la(a, b, c, d, e) {
            return e ? is.fnc(d) ? d(a, b, c) : is.arr(d) ? d[a] ? d[a] : d[0] : a * d : is.fnc(d) ? d(a, b, c) :
                is.arr(d) ? d[a] ? d[a] : d[0] : d
        }
        ...
        function ia(a, c, d, e, f) {
            var g = {};
            "in" == c ? d["inConfig" + a].rotIn ? (g.from = b.extend({}, e, d["inConfig" + a].rotIn.from), g.to = b.extend({}, f, d["inConfig" + a].rotIn.to)) :
                (g.from = b.extend({}, e, d["inConfig" + a].from), g.to = b.extend({}, f, d["inConfig" + a].to)) : d["outConfig" + a].rotOut ? (g.from = b.extend({}, e, d["outConfig" + a].rotOut.from), g.to = b.extend({}, f, d["outConfig" + a].rotOut.to)) : (g.from = b.extend({}, e, d["outConfig" + a].from), g.to = b.extend({}, f, d["outConfig" + a].to));
            return g
        }
        ...
        function qa(a) {
            ...
            b.borTop =
                parseInt(a.css("border-top-width"));
        ...
        function ka(a, d, e, f, g, h, k, l) {
            ...
            c.hasClass("animate-colors") &&
                (h = e % E.colors.length, d.full.to(Cb, d.full.duration(), {
                    backgroundColor: E.colors[h]
                }, 0));
            k && d.full.set({}, {
                immediateRender: !1,
                onComplete: function() {
            ...
            p.freeze = m / k;
            E.showAnimationSummary && (m = "in: " + p.in.toFixed(1) + "s<br/> out: " + p.out.toFixed(1) + "s<br/> freeze: " + p.freeze.toFixed(1) + "s<br/> scene: " +
                p.full.toFixed(1) + "s", d.full.set(Gb, {
                    text: m
                }, .1));
            ...
            S[g] && (l.add(S[g + "-alpha"], g), "full" == S[g].data.duration ? l.add(S[g].duration(Ua),
                "-=" + Ua) : "in" == S[g].data.duration ? l.add(S[g].duration(p.in), g) : l.add(S[g].duration(S[g].data.duration), g), Ua = 0);
            l.set({}, {
                immediateRender: !1,
                onComplete: function() {
                    b.isFunction(E.onBeforeScene) && E.onBeforeScene.call(c, e, a, p, Sa)
                }
            }, g + "-before");
            d.full.set({}, {
                immediateRender: !1,
                onComplete: function() {
                    b.isFunction(E.onBeforeIn) && E.onBeforeIn.call(c, e, a, p, Sa)
                }
            }, g + "-beforeIn");
            d.full.set({}, {
                immediateRender: !1,
                onComplete: function() {
                    b.isFunction(E.onBeforeFreeze) && E.onBeforeFreeze.call(c, e, a, p, Sa)
                }
            }, g + "-beforeFreeze");
            "none" != f.outDur && d.full.set({}, {
                immediateRender: !1,
                onComplete: function() {
                    b.isFunction(E.onBeforeOut) && E.onBeforeOut.call(c, e, a, p, Sa)
                }
            }, g + "-beforeOut");
            l.set({}, {
                immediateRender: !1,
                onComplete: function() {
                    b.isFunction(E.onAfterScene) && E.onAfterScene.call(c, e, a, p, Sa)
                }
            }, g + "-after")
        }
        var aa = this,
            ...
            O = c.attr("id"),
            Ga, ua = isMobile.any,
            La = ua && !E.videoOnMobiles ? !1 : !0,
            Ba = b(window).width(),
            Ta, v = 0,
            U = 0,
            Sa, ja, ya = "sven-default",
            Ua = 0,
            gb = !0,
            za = "",
            ...
            xb = c.attr("data-auto-play-sound") ? parseBool(c.attr("data-auto-play-sound")) : !0,
            Va = c.attr("data-auto-stop-sound") ? parseBool(c.attr("data-auto-stop-sound")) :
            !1,
            ...
            db = c.data().zoomScale ? parseFloat(c.data().zoomScale) : !1,
            ob = c.attr("data-splash-image") ? parseBool(c.attr("data-splash-image")) :
            !1,
            ...
            Xa = c.attr("data-video-loop") ? parseBool(c.attr("data-video-loop")) : !0,
            Ka = c.attr("data-auto-stop-video") ?
            parseBool(c.attr("data-auto-stop-video")) : !1,
            Ab = isMobile.apple.device && E.forceLoadOnClick || ua && E.autoStart,
            ub = "click";
        isMobile.apple.device && (ub = "touchstart");
        isMobile.any && E.forceFallback && (za = "vid-fallback");
        R = c.data().staticVideo && La ? "video-bg" : Aa || hb ? "single-image" : "assorted";
        wa = ra ? -1 : 0;
        ua && c.data().mobileSound && (Da = c.data().mobileSound);
        Ea = Da ? !0 : Ea;
        ua && !E.force3DOnDevices && (gb = !1);
        ua && hb && (Aa = hb);
        var Ra = "<div class='slideshow-wrapper abs-fs'><div class='slideshow-overlay abs-fs'></div></div>";
        "single-image" === R ? (ua && (ab = c.data().mobileImagePos ? c.data().mobileImagePos : "center center"), ab = ab.split(" "), u.push({
            id: "static-image",
            family: "static-image",
            alignX: ab[0],
            alignY: ab[1],
            src: Aa,
            loadTimeout: E.fileTimeout
        ...
        E.letterBoxing && (Ra += "<div class='lbox-top'></div><div class='lbox-bottom'></div>");
        ...
        E.showAnimationSummary && (Ra += "<div id='summary-handle'><i class='fa fa-info'></i></div><div id='summary-container'><div class='details'><h3 class='animation-name'></h3><p class='scene-info'></p><h3 class='total-duration'></h3></div></div>");
        c.wrap("<div class='sven-wrapper'></div>").after(Ra);
        var Pa = c.parent(),
        ...
        0 < E.preloadFiles.length && b.each(E.preloadFiles, function(a, b) {
            u.push({
                src: b,
                family: "user-files",
                loadTimeout: E.fileTimeout
        ...
        // c.find(".sven-slide").each(function(a, c) {
        //     var d;
        ...
        //     }
        // });
        if (La && (0 < A.length || 0 < M.length || "video-bg" === R)) {
            if ("video-bg" === R && "html5" === Qa || 0 < A.length) {
                var cb,
                    P, nb;
                "video-bg" === R && "html5" === Qa ? (Za.css({
                    opacity: "1",
                    visibility: "visible"
                }), cb = d(Xa, c.data().staticVideo, !0), P = cb.getPlayer(), P.off("ended"), P.currentTime(rb), P.on("loadeddata", function() {
                    !t || Ea || oa || (P.muted(!1), P.volume(E.videoVolume));
                    nb.css("visibility", "visible");
                    TweenMax.to(Za, .5, {
                        autoAlpha: 0
                    });
                    P.on("timeupdate", function() {
                        if (0 != fb && P.currentTime() >= fb || 0 == fb && P.currentTime() >= P.duration()) Xa ? (P.loop(!0), P.currentTime(rb), P.play()) : (Na = !0, P.pause())
                    })
                })) : (cb = d(A[0].loop, A[0].videoURL, A[0].mute),
                    P = cb.getPlayer(), P.off("ended"), P.currentTime(A[0].startAt), P.one("loadeddata", function() {
                        kb = !0;
                        !t || A[0].muteEnabled || oa || (P.muted(!1), P.volume(E.videoVolume))
                    }));
                nb = $a.find("#big-video-wrap");
                nb.append("<div class='bv-overlay abs-fs'></div>")
            }
            if ("video-bg" === R && "youtube" === Qa || 0 < M.length) {
                "video-bg" === R && "youtube" === Qa ? (Za.css({
                    opacity: "1",
                    visibility: "visible"
                    ...
                    c.data().staticVideo + '", containment:".' + $a[0].className.split(" ")[0] + '", autoPlay: false, mute: true, startAt: ' + rb + ", stopAt: " + fb + ", opacity: 1}'>My video</div>")) : $a.append("<div id='bgndVideo' class='player' data-property=" + JSON.stringify(M[0]) + ">My video</div>");
                ...
                ta.on("YTPReady", function() {
                    ...
                    qb = !0;
                    t && !oa && ("video-bg" == R && !Ea || 0 < M.length && !M[0].muteEnabled) && (sa.YTPUnmute(), ta.isMute = !1)
                });
                ta.on("YTPEnd", function() {
                    "video-bg" === R ? Na = !0 : eb = !1
                })
            }
        }
        var Fb = Da,
        ...
        Da && Ab && (b(".sound-info").show(), window.addEventListener(ub, function Oa() {
            "tag" == E.preloadMethod && createjs.Sound.registerPlugins([createjs.HTMLAudioPlugin]);
        ...
        E.autoStart ? (b(".sound-info").show(), window.addEventListener(ub, function() {
            t || (t = !0, oa ? (Da && (fa.volume = E.standaloneAudioVolume), b(c).svenPlugin.toggleSound()) : "video-bg" != R || Ea || ("html5" === Qa ? (P.muted(!1), P.volume(E.videoVolume)) : (sa.YTPUnmute(), ta.isMute = !1)), b(".sound-info").hide(), b(".pl-sound").parent().removeClass("highlight"))
        }, {
            once: !0
        ...
        aa.init = function() {
            aa.start(c,
                "start", E.autoStart);
            if (E.showAnimationSummary) Eb.on("click", function(a) {
        ...
        aa.start = function(a, c, d) {
            ...
            // a = a.find(".sven-slide");
            f(0, a, a.length, d, c);
            d = c = N[O].totalDuration();
            "default" != E.fullDuration && 0 < E.fullDuration && (d = E.fullDuration, N[O].totalDuration(d));
            E.showAnimationSummary && (a = "Teaser Duration: " + d.toFixed(1) + "s", Hb.html(a));
            Sa = N[O].timeScale();
            "single-image" === R && db && (a = new TimelineMax({
                delay: 0
            ...
            E.preloadScenes && N[O].set({}, {
                immediateRender: !1,
                onComplete: F
            })
        };
        aa.play = function(a) {
            "start" === a ? N[O].play() : (N[O].play(a), "undefined" !== typeof fa && ("paused" == Ha || xa || B()));
            c.trigger("STPlay")
        };
        aa.seek = function(a) {
            N[O].seek(a);
        ...
        aa.continueTeaser = function() {
            N[O].paused() && "playing" == va ? (N[O].resume(), c.trigger("STPlay"),
                "video-bg" !== R || Na || r(), X(), "undefined" == typeof fa || "paused" === Ha || xa || B()) : 1 <= N[O].progress() && Ca && !E.stopTeaserOnEnd && (Ca = !1, "video-bg" !== R || Na || r(), X(), "paused" === Ha || xa || "undefined" === typeof fa || (fa.paused = !1, c.trigger("STUnMuted")))
        };
        aa.freezeTeaser = function() {
            N[O].paused() || "playing" != va || 1 <= N[O].progress() ? 1 <= N[O].progress() && (Ca = !0, "video-bg" !== R || Na || m(), y(), "undefined" === typeof fa || xa || (fa.paused = !0, c.trigger("STMuted"))) : (N[O].pause(), "video-bg" !== R || Na || m(), y(), c.trigger("STPause"), "undefined" ===
                typeof fa || xa || (fa.paused = !0, c.trigger("STMuted")))
        };
        aa.pauseTeaser = function() {
            ...
            y();
            c.trigger("STPause");
            "undefined" !== typeof fa && (fa.paused = !0, c.trigger("STMuted"));
            va = "paused"
        };
        aa.playTeaser = function() {
            ...
            "video-bg" !== R || Na || r();
            X();
            "undefined" != typeof fa && "paused" !== Ha && B();
            va = "playing"
        };
        b.fn.svenPlugin.skipToLast = function() {
            return N[O].currentLabel() != Ta ? (N[O].seek(Ta, !1).play(), "undefined" !== typeof fa && ("paused" == Ha || xa || B()), !0) : !1
        };
        b.fn.svenPlugin.togglePlay = function() {
            N[O].paused() ? aa.playTeaser() : 1 <= N[O].progress() ? ("video-bg" != R && Q(), xa = eb = Ja = ba = Na = !1, N[O].restart(), c.trigger("STPlay"), va = "playing") : aa.pauseTeaser()
        };
        b.fn.svenPlugin.playTeaser = function() {
            aa.playTeaser()
        };
        b.fn.svenPlugin.pauseTeaser = function() {
            aa.pauseTeaser()
        };
        b.fn.svenPlugin.toggleSound = function() {
            Da ? fa.paused ? (B(), Ha = "playing") : "playFinished" != fa.playState && (fa.paused = !0, c.trigger("STMuted"), Ha = "paused") : "video-bg" === R ? Ea || ("html5" === Qa ? P.muted() ?
        ...
        b.fn.svenPlugin.changeSpeed = function(a) {
            E.videoPlaybackChange && (cb && P.playbackRate(a), sa && sa.YTPGetPlayer().setPlaybackRate(a));
            a *= Sa;
            N[O].timeScale(a)
        };
        Aa || Da || 0 < u.length ? E.waitForLoad ? b(window).load(function() {
            e()
        }) : e() : E.waitForLoad ? b(window).load(function() {
            z()
        }) : z();
    ...
    b.fn.svenPlugin = function(c) {
        var a = this;
        return this.each(function() {
            if (void 0 == b(this).data("svenPlugin")) {
                var d = new b.svenPlugin(a, c);
                b(this).data("svenPlugin", d)
            }
        })
    }
})(jQuery);
